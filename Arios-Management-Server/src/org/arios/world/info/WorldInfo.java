...
public final class WorldInfo {
	 ...
	 */
	public WorldInfo(int id, String address, CountryFlag country, String activity, boolean members, boolean pvp, boolean quickChat, boolean lootshare) {
		this.worldId = id;
