...
public class IoBuffer {
	...
	/**
     * Puts a byte value (+ 128) on the buffer.
     *
     * @param value The value.
     * @return This buffer instance, for chaining.
     */
    public IoBuffer putByteA(int value) {
        return put(value + 128);
    }
	...
	/**
     * Puts a (negative) byte value on the buffer.
     *
     * @param value The value.
     * @return This buffer instance, for chaining.
     */
    public IoBuffer putByteC(int value) {
        return put(-value);
    }
