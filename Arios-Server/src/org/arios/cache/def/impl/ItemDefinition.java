...
public class ItemDefinition extends Definition<Item> {
	...
	public void transferNoteDefinition(ItemDefinition reference, ItemDefinition templateReference) {
		...
		textureColour1 = templateReference.textureColour1;
		configurations.put(ItemConfiguration.TRADEABLE, true);
	}
	...
	public boolean hasRequirement(Player player, boolean wield, boolean message) {
		Map<Integer, Integer> requirements = getConfiguration(ItemConfiguration.REQUIREMENTS);
	...
	public boolean isAllowedOnEntrana() {
		...
		return getConfiguration(ItemConfiguration.BONUS) == null;
	}
	...
	public int getRenderAnimationId() {
		return getConfiguration(ItemConfiguration.RENDER_ANIM_ID, 1426);
	}
	...
	public boolean isTradeable() {
		...
		return !unnoted || getConfiguration(ItemConfiguration.TRADEABLE, false) || GrandExchangeDatabase.getDatabase().get(getId()) != null;
	}
