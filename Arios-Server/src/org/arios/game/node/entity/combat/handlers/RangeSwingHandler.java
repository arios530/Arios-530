package org.arios.game.node.entity.combat.handlers;
...
import org.arios.game.node.entity.combat.equipment.Weapon;
import org.arios.game.node.entity.combat.equipment.Weapon.WeaponType;
...
public class RangeSwingHandler extends CombatSwingHandler {
	...
	public static double getDropRate(Entity e) {
		if (e instanceof Player) {
			...
			if (cape != null && (cape.getId() == 10498 || cape.getId() == 10499) && (weapon != null && weapon.getId() != 10034) && weapon.getId() != 10033) {
				int rate = cape.getId() == 10498 ? 70 : 80;
