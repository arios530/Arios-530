...
import org.arios.game.node.entity.player.link.ConfigurationManager.Configuration;
...
public final class Settings {
	...
	public void update() {
		...
		player.getConfigManager().set(Configuration.SURROUNDING_VOLUME, areaSoundVolume);
