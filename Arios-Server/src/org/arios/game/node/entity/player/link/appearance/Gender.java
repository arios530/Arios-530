 ...
 */
public enum Gender {
	MALE(new BodyPart[] { new BodyPart(0), new BodyPart(10), new BodyPart(18), new BodyPart(26), new BodyPart(33), new BodyPart(36), new BodyPart(42) }), FEMALE(new BodyPart[] { new BodyPart(45), new BodyPart(1000), new BodyPart(56), new BodyPart(64), new BodyPart(69), new BodyPart(77), new BodyPart(80) });
