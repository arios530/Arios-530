package org.arios.game.node.entity.player.link.music;
...
public final class MusicPlayer implements SavingModule {
	...
	public void init() {
		...
		player.getPacketDispatch().sendAccessMask(BitregisterAssembler.calculateRegister(CONFIG_IDS.length), 1, 187, 0, CONFIG_IDS.length * 64);
