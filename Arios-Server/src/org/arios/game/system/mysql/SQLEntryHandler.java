...
public abstract class SQLEntryHandler<T> {
	 ...
	 * @param entry The entry.
	 */
	public static boolean write(SQLEntryHandler<?> entry) {
		return write(entry, entry.getConnection(), true);
	}
	 ...
	 * @param entry The entry.
	 */
	public static boolean write(SQLEntryHandler<?> entry, Connection connection, boolean commit) {
		if (connection == null) {
