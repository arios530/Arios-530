...
public enum LightSource {
	CANDLE(1, new Item(36, 1), new Item(33, 1), true, 98), BLACK_CANDLE(1, new Item(38, 1), new Item(32, 1), true, 98), TORCH(1, new Item(596, 1), new Item(594, 1), true, 98), CANDLE_LANTERN(4, new Item(4527, 1), new Item(4531, 1), false, 98), OIL_LAMP(12, new Item(4522, 1), new Item(4524, 1), true, 97), OIL_LANTERN(26, new Item(4535, 1), new Item(4539, 1), false, 97), BULLSEYE_LANTERN(49, new Item(4544, 1), new Item(4550, 1), false, -1), MINING_HELMET(65, new Item(5014, 1), new Item(5013, 1), false, 97);
