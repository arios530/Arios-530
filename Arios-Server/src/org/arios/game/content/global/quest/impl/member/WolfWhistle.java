...
public class WolfWhistle extends Quest {
	...
	public void update() {
		...
		switch (stage) {
		case 0:
			line(BLUE + "I can begin this quest by talking to " + RED + "Pikkupstix" + BLUE + ", who lives in", 4+ 7);
			line(RED + "Taverley.", 5+ 7);
			break;
		case 10:
			line("<blue>Having spoken to <red>Pikkupstix<blue>, it seems that all I have to do<br><br><blue>is get rid of the <red>little rabbit upstairs in his house.", 4+ 7);
			break;
		case 20:
