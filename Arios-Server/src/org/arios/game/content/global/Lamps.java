 ...
 */
public enum Lamps {
	GENIE_LAMP(new Item(2528), 10), STRONGHOLD_LAMP(new Item(4447), 500), K_ACHIEVEMENT_1(new Item(11137), 1000), K_ACHIEVEMENT_2(new Item(11139), 5000), K_ACHIEVEMENT_3(new Item(11141), 10000), V_ACHIEVEMENT_1(new Item(11185), 2500, 30), V_ACHIEVEMENT_2(new Item(11186), 7500, 40), V_ACHIEVEMENT_3(new Item(11187), 15000, 50);
