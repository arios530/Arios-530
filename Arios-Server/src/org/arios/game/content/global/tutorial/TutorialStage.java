...
public enum TutorialStage {
	...
	STAGE_5(5) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(0, 1, 2, 4, 5, 6, 7, 8, 9, 10, 12, 13);
				player.getConfigManager().set(406, 2);
			} else {
	...
	STAGE_10(10) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(0, 2, 4, 5, 6, 7, 8, 9, 10, 12, 13);
				player.getConfigManager().set(406, 2);
			} else {
	...
	STAGE_21(21) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(0, 2, 4, 5, 6, 7, 8, 9, 10, 12);
				player.getConfigManager().set(406, 4);
			} else {
				removeHintIcon(player);
	...
	STAGE_23(23) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(0, 2, 4, 5, 6, 7, 8, 9, 10);
			} else {
				removeHintIcon(player);
	...
	STAGE_28(28) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(0, 4, 5, 6, 7, 8, 9, 10);
				player.getConfigManager().set(406, 7);
			}
	...
	STAGE_46(46) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(0, 5, 6, 7, 8, 9, 10);
				player.getConfigManager().set(406, 10);
			}
	...
	STAGE_50(50) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(5, 6, 7, 8, 9, 10);
	...
	STAGE_62(62) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(6, 7, 8, 9, 10);
				player.getConfigManager().set(406, 16);
			}
			player.setAttribute("tut-island:hi_slot", HintIconManager.registerHintIcon(player, Repository.findNPC(954)));
	...
	STAGE_64(64) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(6, 7, 10);
				player.getConfigManager().set(406, 16);
			}
	...
	STAGE_65(65) {
		...
		public void run(final Player player) {
			if (login) {
				player.getInterfaceManager().removeTabs(6, 7);
				player.getConfigManager().set(406, 16);
			}
			player.setAttribute("tut-island:hi_slot", HintIconManager.registerHintIcon(player, Repository.findNPC(954)));
