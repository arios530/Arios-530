package org.arios.game.content.skill.member.fletching.items.arrow;
...
public enum ArrowHead {
	BRONZE_ARROW(new Item(39), new Item(882), 1, 2.6), IRON_ARROW(new Item(40), new Item(884), 15, 3.8), STEEL_ARROW(new Item(41), new Item(886), 30, 6.3), MITHRIL_ARROW(new Item(42), new Item(888), 45, 8.8), ADAMANT_ARROW(new Item(43), new Item(890), 60, 10), RUNE_ARROW(new Item(44), new Item(892), 75, 13.8), DRAGON_ARROW(new Item(11237), new Item(11212), 90, 16.3);
