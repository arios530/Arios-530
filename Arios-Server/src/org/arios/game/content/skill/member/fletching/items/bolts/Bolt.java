package org.arios.game.content.skill.member.fletching.items.bolts;
 ...
 */
public enum Bolt {
	BRONZE_BOLT(new Item(9375), new Item(877), 9, 0.5), BLURITE_BOLT(new Item(9376), new Item(9139), 24, 1), IRON_BOLT(new Item(9377), new Item(9140), 39, 1.5), SILVER_BOLT(new Item(9382), new Item(9145), 43, 2.5), STEEL_BOLT(new Item(9378), new Item(9141), 46, 3.5), MITHRIL_BOLT(new Item(9379), new Item(9142), 54, 5), ADAMANTITE_BOLT(new Item(9380), new Item(9143), 61, 7), RUNITE_BOLT(new Item(9381), new Item(9144), 69, 10);
