package org.arios.game.content.skill.free.crafting.jewellery;
...
public class JewelleryCrafting {
	...
	public enum JewelleryItem {
		GOLD_RING(5, 15, 19, 1635, GOLD_BAR), SAPPIRE_RING(20, 40, 21, 1637, SAPPHIRE, GOLD_BAR), EMERALD_RING(27, 55, 23, 1639, EMERALD, GOLD_BAR), RUBY_RING(34, 70, 25, 1641, RUBY, GOLD_BAR), DIAMOND_RING(43, 85, 27, 1643, DIAMOND, GOLD_BAR), DRAGONSTONE_RING(55, 100, 29, 1645, DRAGONSTONE, GOLD_BAR), ONYX_RING(67, 115, 31, 6575, 6573, GOLD_BAR), GOLD_NECKLACE(6, 20, 38, 1654, 2357), SAPPHIRE_NECKLACE(22, 55, 40, 1656, 1607, 2357), EMERALD_NECKLACE(29, 60, 42, 1658, 1605, 2357), RUBY_NECKLACE(40, 75, 44, 1660, 1603, 2357), DIAMOND_NECKLACE(56, 90, 46, 1662, 1601, 2357), DRAGONSTONE_NECKLACE(72, 105, 48, 1664, 1615, 2357), ONYX_NECKLACE(82, 120, 50, 6577, 6573, 2357), GOLD_AMULET(8, 30, 57, 1673, 2357), SAPPHIRE_AMULET(24, 65, 59, 1675, 1607, 2357), EMERALD_AMULET(31, 70, 61, 1677, 1605, 2357), RUBY_AMULET(50, 85, 63, 1679, 1603, 2357), DIAMOND_AMULET(70, 100, 65, 1681, 1601, 2357), DRAGONSTONE_AMULET(80, 150, 67, 1683, 1615, 2357), ONYX_AMULET(90, 165, 69, 6579, 6573, 2357), GOLD_BRACELET(7, 25, 76, 11069, 2357), SAPPHIRE_BRACELET(23, 60, 78, 11072, 1607, 2357), EMERALD_BRACELET(30, 65, 80, 11076, 1605, 2357), RUBY_BRACELET(42, 80, 82, 11085, 1603, 2357), DIAMOND_BRACELET(58, 95, 84, 11092, 1601, 2357), DRAGONSTONE_BRACELET(74, 110, 86, 11115, 1615, 2357), ONYX_BRACELET(84, 125, 88, 11130, 6573, 2357);
	...
	public static void open(final Player player) {
		...
		if (player.getInventory().contains(NECKLACE_MOULD, 1)) {
			player.getPacketDispatch().sendInterfaceConfig(446, 33, true);
			/** hides the mould and text. */
		}
		if (player.getInventory().contains(AMULET_MOULD, 1)) {
			player.getPacketDispatch().sendInterfaceConfig(446, 52, true);
			/** hides the mould and text. */
		}
		if (player.getInventory().contains(BRACELET_MOULD, 1)) {
			player.getPacketDispatch().sendInterfaceConfig(446, 71, true);
			/** hides the mould and text. */
		}
