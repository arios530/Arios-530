...
import org.arios.game.content.skill.free.crafting.armour.LeatherCrafting.DragonHide;
import org.arios.game.content.skill.free.crafting.armour.LeatherCrafting.SoftLeather;
import org.arios.game.content.skill.free.crafting.gem.Gems;
import org.arios.game.content.skill.free.crafting.jewellery.JewelleryCrafting;
import org.arios.game.content.skill.free.crafting.jewellery.JewelleryCrafting.JewelleryItem;
import org.arios.game.content.skill.free.crafting.pottery.PotteryItem;
...
import org.arios.game.content.skill.member.farming.patch.Allotments;
...
import org.arios.game.content.skill.member.fletching.items.crossbow.Limb;
...
import org.arios.game.content.skill.member.herblore.FinishedPotion;
...
public final class ResourceManager {
	...
	public static void kickStartEconomy() {
		...
		for (int itemId : handledResources) {
			...
			int amount = def.getConfiguration(ItemConfiguration.GE_LIMIT, 500) * 100;
