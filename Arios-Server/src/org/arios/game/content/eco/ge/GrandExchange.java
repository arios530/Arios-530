package org.arios.game.content.eco.ge;
...
import org.arios.game.container.access.InterfaceContainer;
...
public final class GrandExchange implements SavingModule {
	...
	public void hideMemberSlots() {
		// This is done on login!
		// player.getPacketDispatch().sendInterfaceConfig(105, 98, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 99, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 100, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 101, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 105, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 104, false);
		// player.getPacketDispatch().sendInterfaceConfig(105, 117, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 118, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 119, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 120, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 124, true);
		// player.getPacketDispatch().sendInterfaceConfig(105, 123, false);
	}
	...
	public void openBuy(int index) {
		if (player.getDetails().getRights() == Rights.ADMINISTRATOR && (!player.getName().equals("vexia") && !player.getName().equals("splinter") && !player.getName().equals("emperor"))) {
			player.sendMessage("You can't open that as an Arios moderator.");
			return;
		}
	...
	public void openSell(int index) {
		...
		BitregisterAssembler.send(player, 107, 18, 0, 27, 2);
	}
	 ...
	 * @return the formatted offer for the DB.
	 */
