...
import org.arios.game.world.map.build.RegionFlags;
import org.arios.game.world.update.flag.chunk.ItemUpdateFlag;
...
public final class RegionPlane {
	...
	public RegionChunk getRegionChunk(int chunkX, int chunkY) {
		...
		if (r == null) {
			r = chunks[chunkX][chunkY] = new RegionChunk(region.getBaseLocation().transform(chunkX << 3, chunkY << 3, plane), 0, this);
		}
		return r;
	}
