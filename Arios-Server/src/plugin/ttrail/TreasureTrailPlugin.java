...
import org.arios.game.content.global.ttrail.ClueScrollPlugin;
import org.arios.game.content.global.ttrail.CoordinateClueScroll;
...
public final class TreasureTrailPlugin extends OptionHandler {
	...
	public final class ClueItemPlugin extends ItemPlugin {
		...
		public Item getItem(Item item, NPC npc) {
			return ClueScrollPlugin.getClue(npc.getDefinition().getConfiguration(NPCConfiguration.CLUE_LEVEL, ClueLevel.EASY)).copy();
		}
