...
public final class BrimhavenDungeonPlugin extends OptionHandler {
	...
	public boolean handle(final Player player, Node node, String option) {
		...
		case 5088:
			...
			AgilityHandler.walk(player, -1, player.getLocation(), Location.create(2687, 9506, 0), Animation.create(762), 0, null);
			return true;
		case 5090:
			if (player.getSkills().getLevel(Skills.AGILITY) < 30) {
				player.getPacketDispatch().sendMessage("You need an agility level of 30 to cross this.");
			...
			AgilityHandler.walk(player, -1, player.getLocation(), Location.create(2682, 9506, 0), Animation.create(762), 0, null);
			return true;
		case 5099:
		case 5100:
