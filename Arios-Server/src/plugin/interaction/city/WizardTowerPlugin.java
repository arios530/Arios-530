...
public final class WizardTowerPlugin extends OptionHandler {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		...
		ObjectDefinition.forId(32015).getConfigurations().put("option:climb-up", this); // Lumbridge
		// basement
		// uses
		// this
		// object
	...
	public final static class SedridorDialogue extends DialoguePlugin {
		...
		public boolean handle(int interfaceId, int buttonId) {
			...
			case 23:
				...
				break;
			case 24:
				interpreter.sendOptions("Select an Option", "Aaah... that would be telling adventurer. Anything I", "have found I cannot speak freely of, for fear the", "treachery of the past might be repeated.");
				stage = 25;
				break;
			case 25:
