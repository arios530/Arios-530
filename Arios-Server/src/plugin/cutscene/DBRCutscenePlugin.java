...
public final class DBRCutscenePlugin extends CutscenePlugin {
	...
	public void configure() {
		...
		player.getDialogueInterpreter().sendPlaneMessage(true, "You close your eyes and watch the recording...");
	}
	...
	public final class RecordingPulse extends Pulse {
		...
		/**
		 * Constructs a new {@code RecordingPulse} {@code Object}.
		 */
		...
		public boolean pulse() {
			...
			case 124:
				...
				break;
			case 126:
				getMarketGuard().setHidden(false);
