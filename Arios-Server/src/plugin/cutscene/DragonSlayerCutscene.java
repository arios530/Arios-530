...
public final class DragonSlayerCutscene extends CutscenePlugin {
	...
	public void end() {
		...
		player.getQuestRepository().getQuest("Dragon Slayer").setStage(40);
		...
		public boolean handle(int interfaceId, int buttonId) {
			...
			case 30:
				...
				case 503:
					...
					interpreter.sendPlaneMessage(true, "Clouds surround the ship.");
				...
				case 512:
					...
					player.getDialogueInterpreter().sendPlaneMessage(true, "<col=8A0808>CRASH!");
					cutscene.stop(true);
					finished = true;
					break;
				case 0:
