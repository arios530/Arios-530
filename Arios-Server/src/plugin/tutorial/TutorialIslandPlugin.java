...
public class TutorialIslandPlugin extends OptionHandler {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		...
		PluginManager.definePlugin(new BrotherBraceDialogue(), new CombatInstructorDialogue(), new FinancialAdvisorDialogue(), new MasterChefDialogue(), new MiningInstructorDialogue(), new QuestGuideDialogue(), new RSGuideDialogue(), new SurvivalExpertDialogue(), new TutorialCompletionDialogue());
		return this;
	}
