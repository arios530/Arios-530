...
public final class DemonSlayerCutscene extends CutscenePlugin {
	...
	public boolean enter(final Entity entity) {
		...
		if (quest.getStage() == 30 && !in && (player.getEquipment().containsItem(DemonSlayer.SILVERLIGHT) || player.getInventory().containsItem(DemonSlayer.SILVERLIGHT))) {
	...
	public static final class DelrithDialoguePlugin extends DialoguePlugin {
		...
		public boolean handle(int interfaceId, int buttonId) {
			...
			case 3:
				...
				break;
			case 4:
				interpreter.sendPlaneMessage(true, "Delrith is sucked into the vortex...");
			...
			case 5:
				...
				player.getQuestRepository().getQuest("Demon Slayer").finish();
				end();
				break;
			}
			return true;
	...
	public static final class DenathDialogue extends DialoguePlugin {
		...
		public boolean handle(int interfaceId, int buttonId) {
			...
			case 1:
				...
				interpreter.sendPlaneMessage(true, "The wizards cast an evil spell...");
