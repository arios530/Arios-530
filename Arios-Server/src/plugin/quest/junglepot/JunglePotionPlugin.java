...
import org.arios.game.content.global.quest.impl.member.JunglePotion.JungleObjective;
...
public final class JunglePotionPlugin extends OptionHandler {
	...
	private void search(final Player player, Quest quest, final GameObject object, final JungleObjective objective) {
		if (quest.getStage() < objective.getStage()) {
	 ...
	 * @author Vexia
	 */
	public final class JogreCavernDialogue extends DialoguePlugin {
