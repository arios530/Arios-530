...
public final class AvaDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 100:
			...
			case 10:
				...
				player.getPacketDispatch().sendItemZoomOnInterface(10498, 240, 140, 5);
	...
	public boolean canBuyUpgrade(Player player) {
		if (player.hasItem(AnimalMagnetism.AVAS_ACCUMULATOR))
			return true;
		return player.getSkills().getStaticLevel(Skills.RANGE) >= 50 && player.hasItem(AnimalMagnetism.AVAS_ATTRACTOR);
	}
