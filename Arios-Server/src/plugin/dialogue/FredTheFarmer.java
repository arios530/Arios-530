...
public final class FredTheFarmer extends DialoguePlugin {
	...
	public boolean open(Object... args) {
		...
		if (player.getQuestRepository().getQuest("Sheep Shearer").getStage() == 10 || player.getQuestRepository().getQuest("Sheep Shearer").getStage() == 90) {
			if (SheepShearer.getWoolGiven(player) == 20 && player.getQuestRepository().getQuest("Sheep Shearer").getStage() == 90) {
		...
		case 5011:
			...
			if (SheepShearer.addWool(player)) {
				if (SheepShearer.getWoolGiven(player) == 20) {
					player.getQuestRepository().getQuest("Sheep Shearer").setStage(90);
				}
