 ...
 * @version 1.0
 */
public final class AriosRuleBook extends Book {
	...
	public DialoguePlugin newInstance(Player player) {
		return new AriosRuleBook(player);
	}
