...
public final class MiningSkillCapeDwarfDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 21:
			...
			break;
		case 22:
			interpreter.sendDialogues(npc, FacialExpression.NORMAL, "No, this is only a mining outpost. We dwarves don't much", "like to settle in human cities. Most of the ore is carted off", "to Keldagrim, the great dwarven city. They've got a", "special blast furnace up there - it makes smelting the ore");
			stage = 12;
			break;
		case 10:
			interpreter.sendDialogues(npc, FacialExpression.NORMAL, "Ooh, it's WONDERFUL! There are lots of coal rocks,", "and even a few mithril rocks in the guild,", "all exclusively for people with at least level 60 mining.", "There's no better mining site anywhere near here.");
			stage = 11;
			break;
		case 11:
			interpreter.sendOptions("What would you like to say?", "What have you got in the Guild?", "What do you dwarves do with the ore you mine?", "Can you tell me about your skillcape?", "No thanks, I'm fine.");
			...
			break;
		case 12:
			interpreter.sendDialogues(npc, FacialExpression.NORMAL, "so much easier. There are plenty of dwarven traders", "working in Keldagrim. Anyway, can I help you with anything ", "else?");
			stage = 11;
			break;
		case 30:
			end();
			break;
		case 40:
			interpreter.sendDialogues(npc, FacialExpression.NORMAL, "Sure, this is a Skillcape of Mining. It shows my stature as", "a master miner! It has all sorts of uses , if you", "have a level of 99 mining I'll sell you one.");
			stage = 41;
			break;
		case 41:
		...
		case 44:
			...
			break;
		case 45:
			npc("It will cost you 99,000 gold coins, are you sure?");
			stage = 46;
			break;
		case 46:
			options("Yes.", "No.");
		...
		case 48:
			if (!player.getInventory().containsItem(COINS)) {
				npc("You need 99,000 gold coins in order to buy a Skillcape", "of mining.");
				stage = 44;
				return true;
			}
