...
import org.arios.game.content.skill.free.crafting.armour.DragonCraftPulse;
import org.arios.game.content.skill.free.crafting.armour.HardCraftPulse;
...
public final class LeatherCraftDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case "dragon":
			...
			if (buttonId > 8 && buttonId < 13) {
				index = 2;
			}
			if (buttonId > 12 && buttonId < 17) {
				index = 3;
			}
