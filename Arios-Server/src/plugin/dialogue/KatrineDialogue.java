...
public final class KatrineDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		if (quest.getStage() == 60 && stage >= 200) {
			switch (stage) {
			case 200:
		...
		case 50:
			...
			case 160:
				...
				break;
			case 161:
				npc("Normally we recruit for our gang by watching local", "thugs and thieves in action. People don't normally waltz", "in here saying 'hello, can I play'.");
				stage = 162;
				break;
			case 162:
