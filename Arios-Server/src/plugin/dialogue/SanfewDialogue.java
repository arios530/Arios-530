...
public class SanfewDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		switch (stage) {
		case 0:
			if (player.getQuestRepository().getQuest("Drudic Ritual").getStage() == 20) {
		...
		case 8:
			...
			player.getQuestRepository().getQuest("Drudic Ritual").setStage(20);
			stage = 9;
			break;
		case 9:
			end();
		...
		case 202:
			...
			player.getQuestRepository().getQuest("Drudic Ritual").setStage(99);
