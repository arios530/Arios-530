...
public class PlayerSafetyTest extends DialoguePlugin {
	...
	public static TestQuestions forStage(int stage) {
		for (TestQuestions question : TestQuestions.values()) {
			if (question.value() == stage) {
				return question;
			}
		}
		return null;
