...
public class ProfessorHenryDialogue extends DialoguePlugin {
	...
	private void showReward(Player player) {
		...
		player.getPacketDispatch().sendString("You have completed the Player Safety test!", 277, 2);
		player.getPacketDispatch().sendString("2 Experience lamps", 277, 8);
		player.getPacketDispatch().sendString("Access to the Stronghold of", 277, 9);
		player.getPacketDispatch().sendString("Player Safety Dungeon", 277, 10);
		player.getPacketDispatch().sendString("The Safety First' emote", 277, 11);
		player.getPacketDispatch().sendItemZoomOnInterface(12626, 240, 277, 3);
