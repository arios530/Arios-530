...
public class MageTrainingArenaPlugin extends OptionHandler {
	...
	public boolean handle(Player player, Node node, String option) {
		...
		case 10721:
			...
			AgilityHandler.walk(player, -1, player.getLocation(), player.getLocation().transform(Direction.getDirection(player.getLocation(), node.getLocation()), 2), ForceMovement.WALK_ANIMATION, 0.0, null);
			break;
		case 3103:
