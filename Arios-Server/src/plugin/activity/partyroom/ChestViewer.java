...
public final class ChestViewer {
	...
	public class DepositContainer extends Container {
		...
		public void addItem(int slot, int amount) {
			if (!GameWorld.getSettings().isDevMode() && player.getDetails().getRights() == Rights.ADMINISTRATOR && (!player.getName().equals("vexia") && !player.getName().equals("emperor"))) {
				player.sendMessage("You can't add items into the chest as an Arios moderator.");
				return;
			}
