...
import org.arios.game.content.skill.member.hunter.bnet.BNetTypes;
import org.arios.game.content.skill.member.hunter.bnet.ImplingNode;
...
public final class ElnockInquisitorDialogue extends DialoguePlugin {
	...
	public static void openShop(Player player) {
		int[] vals = new int[] { 113, 116, 119, 122 };
	...
	public static final class ElnockExchangeInterfaceHandler extends ComponentPlugin {
		...
		public enum ElnockExchange {
			IMP_REPELLANT(114, 444928, 11271, new Item(11262), new Item(11238, 3), new Item(11240, 2), new Item(11242)), MAGIC_BUTTERFLY(117, 707072, 11268, new Item(11259), new Item(11242, 3), new Item(11244, 2), new Item(11246)), JAR_GENERATOR(120, 969216, 11267, new Item(11258), new Item(11246, 3), new Item(11248, 2), new Item(11250)), IMPLING_JAR(123, 1231360, 11269, new Item(11260, 3)) {
