...
import org.arios.game.content.skill.SkillRestoration;
...
public class PrayerAltarPlugin extends OptionHandler {
	...
	public boolean handle(Player player, Node node, String option) {
		if (option.equalsIgnoreCase("check")) {
			...
			if (quest.getStage() == 70) {// You don't have to memorize the
				// incantation below. Your character
				// will automatically say it during
				// the quest.
