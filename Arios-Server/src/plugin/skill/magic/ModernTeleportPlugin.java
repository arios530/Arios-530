...
public final class ModernTeleportPlugin extends MagicSpell {
	...
	public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
		// home
		SpellBook.MODERN.register(0, new ModernTeleportPlugin(0, 0, ServerConstants.getHomeLocation()));
		// varrock
		...
		// lumby
		SpellBook.MODERN.register(18, new ModernTeleportPlugin(31, 41, ServerConstants.getHomeLocation(), new Item(Runes.EARTH_RUNE.getId()), new Item(Runes.AIR_RUNE.getId(), 3), new Item(Runes.LAW_RUNE.getId(), 1)));
		// fally
		...
		// house
		SpellBook.MODERN.register(23, new ModernTeleportPlugin(40, 50, ServerConstants.getHomeLocation(), new Item(Runes.LAW_RUNE.getId()), new Item(Runes.AIR_RUNE.getId(), 1), new Item(Runes.EARTH_RUNE.getId(), 1)));
		// camelot
