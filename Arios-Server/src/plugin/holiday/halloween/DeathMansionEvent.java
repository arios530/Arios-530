...
import org.arios.game.content.holiday.HolidayItem;
import org.arios.game.content.holiday.HolidayType;
...
public class DeathMansionEvent extends HolidayEvent {
	...
	public boolean leave(Entity e, boolean logout) {
		if (e instanceof Player) {
			...
			player.getProperties().setSpawnLocation(ServerConstants.getHomeLocation());
		}
					...
					GameWorld.submit(new Pulse(1, p) {
						...
						public boolean pulse() {
							...
							case 2:
								...
								break;
							case 4:
								p.getPacketDispatch().sendGlobalPositionGrapicc(86, object.getLocation());
