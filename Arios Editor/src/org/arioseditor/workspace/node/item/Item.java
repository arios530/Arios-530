package org.arioseditor.workspace.node.item;
...
public final class Item extends Node<ItemDefinition> {
	...
	public void setDefaultConfigs() {
		...
		getConfigurations().put("tokkul_price", new Configuration<Integer>(39, (int) 0));
		getConfigurations().put("fun_weapon", new Configuration<Boolean>(40, false));
		getConfigurations().put("render_anim", new Configuration<Short>(41, (short) 1426));
	}
