...
final class Class3_Sub28_Sub10_Sub1 extends Class3_Sub28_Sub10 {
   ...
   private static RSString aClass94_4055 = Class3_Sub4.createRSString(" has logged in)3", (byte)-120);
   Class41 aClass41_4056;
   static RSString aClass94_4057 = Class3_Sub4.createRSString("Mem:", (byte)-128);
   ...
   static final void method593(Frame var0, boolean var1, Class87 var2) {
      try {
         if(!var1) {
            method594(110, 94);
         }
