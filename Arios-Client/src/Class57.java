...
final class Class57 {
   ...
   int anInt896 = 0;
   static RSString aClass94_897 = Class3_Sub4.createRSString("Liste des mises -9 jour charg-Be", (byte)-121);
   static int[] anIntArray898 = new int[2500];
   int anInt899 = 2048;
   static int anInt900;
   static RSString aClass94_901 = Class3_Sub4.createRSString("Ihre Ignorieren)2Liste ist voll)1 Sie k-Onnen nur 100 Spieler darauf eintragen)3", (byte)-125);
   static int anInt902 = 100;
   static int anInt903;
   static int[] anIntArray904 = new int[200];
   static RSString aClass94_905 = Class3_Sub4.createRSString("Sprites charg-Bs", (byte)-118);
