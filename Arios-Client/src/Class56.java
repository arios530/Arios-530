...
final class Class56 {
   ...
   static RSString aClass94_888 = Class3_Sub4.createRSString("<col=ffff00>", (byte)-128);
   static int anInt889;
   static Class106[] aClass106Array890;
   
   static RSString aClass94_892 = Class3_Sub4.createRSString(" )2> <col=ffffff>", (byte)-117);
   static int anInt893 = 0;
   private static RSString aClass94_894 = Class3_Sub4.createRSString("Walk here", (byte)-119);
