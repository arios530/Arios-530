...
final class Class79 {
   ...
   static RSString aClass94_1122 = Class3_Sub4.createRSString("M-Bmoire en cours d(Wattribution", (byte)-126);
   int anInt1123;
   ...
   int anInt1128;
   static RSString aClass94_1129 = Class3_Sub4.createRSString("Clientscript error )2 check log for details", (byte)-117);
         ...
         if(-2 >= ~(-var0.index + var0.buffer.length)) {
            ...
            if(var2 >= 0 && ~var2 >= -12) {
               ...
               if(~(var0.buffer.length - var0.index) <= ~var3) {
                  ...
                  if(~var2 <= -6) {
                     RSString.anInt2148 = var0.getInt(-502942936);
                  }
