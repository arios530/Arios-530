...
final class Class65 {
   ...
   static RSString aClass94_981 = Class3_Sub4.createRSString("S-Blectionner", (byte)-123);
   static RSString aClass94_982 = Class3_Sub4.createRSString("niveau ", (byte)-128);
   static Class61 aClass61_983 = new Class61();
   static int anInt984 = 0;
   static RSString aClass94_985 = Class3_Sub4.createRSString("Fps:", (byte)-124);
   static RSByteBuffer[] aClass3_Sub30Array986 = new RSByteBuffer[2048];
   static int anInt987 = 0;
   static RSString aClass94_988 = Class3_Sub4.createRSString("voudrait faire un -Bchange avec vous)3", (byte)-123);
   static RSString aClass94_989 = Class3_Sub4.createRSString(" est d-Bj-9 dans votre liste d(Wamis)3", (byte)-120);
   static int currentChunkX;
   static int anInt991 = -1;
   static RSString aClass94_992 = Class3_Sub4.createRSString("http:)4)4", (byte)-121);
