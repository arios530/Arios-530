...
public final class client extends Applet_Sub1 {
	...
	private static RSString aClass94_2198 = Class3_Sub4.createRSString("cyan:", (byte)-124);
	static int anInt1855 = 600; //Client zoom
		...
		try {
			...
			if(~Class143.anInt1875 != -1001) {
				...
				if((-31 == ~Class143.anInt1875 || -11 == ~Class143.anInt1875) && (Class3_Sub28_Sub5.aBoolean3593 || ~Class53.aLong866 != -1L && Class53.aLong866 < Class5.method830((byte)-55))) {
					Class140.method1862(Class3_Sub28_Sub5.aBoolean3593, Class83.getScreenMode(0), -8914, Class3_Sub13.anInt2378, Class3_Sub13_Sub5.anInt3071);
				}
				...
				if(null == Class3_Sub13_Sub10.aFrame3121) {
					...
					if(var4 != Class3_Sub9.anInt2334 || ~var5 != ~Class70.anInt1047) {
						if(Class87.osName.startsWith("mac")) {
				...
				if(Class138.highDetail && -1 != ~Class143.anInt1875) {
					Class138.method1826();
						...
						try {
							...
							for(var5 = 0; Class3_Sub28_Sub3.anInt3557 > var5; ++var5) {
								if(Class163_Sub1_Sub1.aBooleanArray4008[var5]) {
									Class164_Sub1.aClass158_3009.method2184(Class3_Sub28_Sub18.anIntArray3768[var5], Class155.anIntArray1969[var5], 6260, Class140_Sub4.anIntArray2794[var5], var11, Player.anIntArray3954[var5]);
				...
				if(RSString.aBoolean2146 && 10 == Class143.anInt1875 && 0 != ~Class3_Sub28_Sub12.anInt3655) {
			...
			System.out.println("Exception has happened: " + e.getMessage());
		}
	}
	...
	static final RSInterface method42(RSInterface var0) {
		...
		if(var1 == 0) {
			...
			for(int var2 = 0; var2 < var1; ++var2) {
				var0 = Class7.getRSInterface((byte)127, var0.anInt190);
				if(var0 == null) {
					return null;
				}
			}
	...
	public final void init() {
		try {
			if(this.method29(27496)) {
				ObjectDefinition.worldId = Integer.parseInt(this.getParameter("worldid"));
	...
	final void method39(int var1) {
		try {
			...
			if(Class44.anInt718 != 0) {
				...
				RuntimeException_Sub1.worldListHost = this.getCodeBase().getHost();
				Class53.anInt867 = 43594; //443 is secure port
			...
			Class38_Sub1.aString2611 = RuntimeException_Sub1.worldListHost;
			...
			try {
				...
				//throw general exception, probably
			} catch (Exception e) {
	...
	static final Class142 method45(int var0, byte var1) {
		try {
			...
			Class142 var2 = (Class142)Class82.aClass93_1146.get((long)var0, (byte)121);
			if(var2 == null) {
				byte[] var3 = Class142.aClass153_1860.getFile(Class129.method1765(var0, -1732504441), (byte)-122, Class67.method1262(117, var0));
				var2 = new Class142();
				var2.anInt1864 = var0;
				if(var3 != null) {
	...
	private final void method47(byte var1) {
		try {
			...
			while(true) {
					...
					while(true) {
						...
						if(null == var11) {
							while(true) {
								...
								if(0 <= var12.anInt191) {
									var13 = Class7.getRSInterface((byte)118, var12.anInt190);
						...
						var12 = var11.aClass11_2449;
						if(~var12.anInt191 <= -1) {
							var13 = Class7.getRSInterface((byte)112, var12.anInt190);
				...
				var12 = var11.aClass11_2449;
				if(var12.anInt191 >= 0) {
					var13 = Class7.getRSInterface((byte)126, var12.anInt190);
			...
			if(~Class3_Sub13_Sub5.anInt3068 < -1) {
				...
				try {
					...
					if(2 == PacketParser.anInt80) {
						...
						var2.putInt(var1 + 31252, 530);
						InputStream_Sub1.js5Connection.sendBytes(false, 0, var2.buffer, 5);
						++PacketParser.anInt80;
						Class3_Sub13_Sub30.aLong3366 = Class5.method830((byte)-55);
					}

					if(3 == PacketParser.anInt80) {
						if(-1 != ~Class143.anInt1875 && ~Class143.anInt1875 != -6 && 0 >= InputStream_Sub1.js5Connection.availableBytes(var1 ^ 15655)) {
	...
	public static final void main(String[] var0) {
		try {
			try {
				...
				var6.method40(32 - -Class3_Sub13_Sub13.anInt3148, 530, false, 1024, "arios", 768, -8057, 28);
	...
	static final void handleItemSwitch(RSInterface[] interfaces, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for(int index = 0; index < interfaces.length; ++index) {
			...
			if(inter != null && inter.anInt190 == var1 && (!inter.aBoolean233 || inter.anInt187 == 0 || inter.aBoolean195 || method44(inter).anInt2205 != 0 || inter == PacketParser.aClass11_88 || inter.anInt189 == 1338) && (!inter.aBoolean233 || !method51(inter))) {
				...
				if(!inter.aBoolean233 || var12 < var14 && var13 < var15) {
					if(inter.anInt187 == 0) {
						if(!inter.aBoolean233 && method51(inter) && Class107.aClass11_1453 != inter) {
							continue;
						}

						if(inter.aBoolean219 && Class126.anInt1676 >= var12 && Class130.anInt1709 >= var13 && Class126.anInt1676 < var14 && Class130.anInt1709 < var15) {
							for(CS2Script var27 = (CS2Script)Class110.aClass61_1471.method1222(-18); var27 != null; var27 = (CS2Script)Class110.aClass61_1471.method1221(4)) {
					...
					if(inter.aBoolean233) {
						...
						if(Class56.aClass11_886 != null && Class56.aClass11_886 != inter && var26 && method44(inter).method98(false)) {
					...
					if(!inter.aBoolean233 && Class56.aClass11_886 == null && Class67.aClass11_1017 == null && !Class38_Sub1.aBoolean2615) {
						...
						if(inter.anInt187 == 8 && Class126.anInt1676 >= var12 && Class130.anInt1709 >= var13 && Class126.anInt1676 < var14 && Class130.anInt1709 < var15) {
				...
				if(Class96.anInt1354 == 0) {
					...
					if(-11 == ~Class96.anInt1354) {
						...
						if(Class151.aClass8_1936.method837(255)) {
							...
							Node.aClass153_2573 = Class8.method842(false, true, true, 11, true);
							Class3_Sub1.aClass153_2203 = Class8.method842(false, true, true, 12, true);
							CacheIndex.aClass153_1948 = Class8.method842(false, true, true, 13, true);
							Class3_Sub19.aClass153_2474 = Class8.method842(false, false, true, 14, true);
							NPC.aClass153_3994 = Class8.method842(false, true, true, 15, true);
							Class168.aClass153_2097 = Class8.method842(false, true, true, 16, true);
							NPC.aClass153_3993 = Class8.method842(false, true, true, 17, true);
							...
							Class132.libIndex = Class8.method842(false, true, true, 28, true);
						...
						if(~Class96.anInt1354 == -46) {
								...
								if(~Class96.anInt1354 != -66) {
									if(Class96.anInt1354 != 70) {
													...
													if(~Class96.anInt1354 == -131) {
														if(Class140_Sub3.aClass153_2727.method2113((byte)20)) {
															if(Class3_Sub1.aClass153_2203.method2113((byte)46)) {
																...
																Class3_Sub17.aClass94_2464 = RenderAnimationDefinition.method903(new RSString[]{Class151_Sub1.aClass94_2961, Class72.method1298((byte)9, 75 - -(Class3_Sub1.aClass153_2203.method2136((byte)-128) / 10)), Class24.aClass94_468}, (byte)-120);
																Class3_Sub28_Sub15.anInt3684 = 85;
															}
														} else {
														...
														Class3_Sub22.anInt2529 = Class140_Sub3.aClass153_2727.method2120(NPC.aClass94_3992, (byte)-30);
										...
										if(~var2 <= -1101) {
											...
											Class3.method89(true, CacheIndex.aClass153_1948, Class140_Sub6.aClass153_2906, Class140_Sub3.aClass153_2727, Class159.aClass153_2019);
									...
									Class3_Sub28_Sub9.method581(CacheIndex.aClass153_1948, 0, Class140_Sub6.aClass153_2906);
							...
							var2 = Class3_Sub13_Sub12.method228(Class140_Sub6.aClass153_2906, CacheIndex.aClass153_1948, false);
