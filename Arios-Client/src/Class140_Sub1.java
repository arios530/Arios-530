...
abstract class Class140_Sub1 extends Class140 {
   ...
   private final void method1875(Class3_Sub17 var1, Class98 var2, Class98 var3, int var4, int var5, boolean[] var6, boolean var7, boolean var8, int var9, int[] var10) {
      int var11;
      if(var3 != null && var4 != 0) {
         var11 = 0;
         int var34 = 0;
   ...
   final void method1877(Class3_Sub28_Sub5 var1, int var2) {
      if(var2 != -1) {
         if(this.method1873()) {
            Class98 var3 = var1.aClass98Array3588[var2];
            Class3_Sub17 var4 = var3.aClass3_Sub17_1384;
   ...
   final void method1880(Class3_Sub28_Sub5 var1, int var2, Class3_Sub28_Sub5 var3, int var4, int var5, int var6, boolean var7) {
      if(var2 != -1) {
         if(this.method1873()) {
            Class98 var8 = var1.aClass98Array3588[var2];
            Class3_Sub17 var9 = var8.aClass3_Sub17_1384;
            Class98 var10 = null;
            if(var3 != null) {
   ...
   abstract void method1881(int var1, int var2, int var3);

   abstract Class140_Sub1 method1882(boolean var1, boolean var2, boolean var3);
   ...
   final void method1887(Class3_Sub28_Sub5 var1, int var2, Class3_Sub28_Sub5 var3, int var4, int var5, int var6, int var7, boolean var8, int[] var9) {
      if(var2 != -1) {
         if(this.method1873()) {
            Class98 var10 = var1.aClass98Array3588[var2];
            Class3_Sub17 var11 = var10.aClass3_Sub17_1384;
            Class98 var12 = null;
            if(var3 != null) {
   ...
   abstract Class140_Sub1 method1890(boolean var1, boolean var2, boolean var3);

   abstract void method1891(int var1, int[] var2, int var3, int var4, int var5, boolean var6);

   final void method1892(Class3_Sub28_Sub5 var1, int var2, Class3_Sub28_Sub5 var3, int var4, int var5, int var6, Class3_Sub28_Sub5 var7, int var8, Class3_Sub28_Sub5 var9, int var10, int var11, int var12, boolean[] var13, boolean var14) {
      if(var2 != -1) {
         if(var13 != null && var8 != -1) {
            if(this.method1873()) {
               Class98 var15 = var1.aClass98Array3588[var2];
               Class3_Sub17 var16 = var15.aClass3_Sub17_1384;
               Class98 var17 = null;
               if(var3 != null) {
               ...
               Class98 var18 = var7.aClass98Array3588[var8];
               Class98 var19 = null;
               if(var9 != null) {
   ...
   abstract Class140_Sub1 method1894(boolean var1, boolean var2, boolean var3);
