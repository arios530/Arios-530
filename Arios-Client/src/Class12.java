...
final class Class12 {
   ...
   private static RSString aClass94_321 = Class3_Sub4.createRSString("Checking for updates )2 ", (byte)-123);
   static CacheIndex aClass153_322;
   static CacheIndex aClass153_323;
   int anInt324;
   static RSString aClass94_325 = Class3_Sub4.createRSString(",Mcran)2titre charg-B", (byte)-126);
   int anInt326;
   static RSString aClass94_327 = aClass94_321;
   long aLong328;
   boolean aBoolean329 = false;
   int anInt330;
   static RSString aClass94_331 = Class3_Sub4.createRSString("(U1", (byte)-124);
