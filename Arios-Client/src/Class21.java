...
final class Class21 {
   ...
   static RSString aClass94_442 = Class3_Sub4.createRSString("Number of player models in cache:", (byte)-121);
   static int anInt443;
   static RSString aClass94_444 = Class3_Sub4.createRSString("<img=1>", (byte)-125);
