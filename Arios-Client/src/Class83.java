...
final class Class83 {
                        ...
                        if(~var44 <= -1 && var44 <= -1 + var41.length) {
                           ...
                           if(null != var41[var44]) {
                              ...
                              if(-1 != ~var26) {
                                 ...
                                 Class109_Sub1 var48 = var47.method77(var28, (byte)-71);
                                 if(var48 != null) {
      ...
      try {
         if(Class3_Sub13_Sub10.aFrame3121 == null) {
            if((Class138.highDetail && Class3_Sub15.aBoolean2427) || Class73.resizableSD) {
               ...
               return Class138.highDetail && !Class3_Sub15.aBoolean2427?1:0;
            }
         } else {
            return 3;
         }
   ...
   final Class3_Sub12_Sub1 method1413(int var1, int var2, int[] var3) {
      try {
         if(1 != this.aClass153_1153.method2121(0)) {
            if(-2 == ~this.aClass153_1153.method2142(var1, (byte)83)) {
   ...
   final Class3_Sub12_Sub1 method1416(int var1, int var2, int[] var3) {
      try {
         ...
         } else if(-2 != ~this.aClass153_1157.method2142(var2, (byte)99)) {
            throw new RuntimeException();
         } else {
