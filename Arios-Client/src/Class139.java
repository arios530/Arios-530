...
final class Class139 {
   ...
   static RSString aClass94_1826 = Class3_Sub4.createRSString("<col=00ffff>", (byte)-121);
   static boolean aBoolean1827;
   static byte[][][] aByteArrayArrayArray1828;
   static int anInt1829 = 0;
   static RSString aClass94_1830 = Class3_Sub4.createRSString("::pcachesize", (byte)-117);
