...
final class Class3_Sub28_Sub9 extends Node {
   ...
   private final void method579(int var1, RSByteBuffer var2, int var3) {
      try {
         if(~var1 != -2) {
            if(var1 == 2) {
               this.anInt3614 = var2.getInt(-502942936);
            } else if(-6 == ~var1) {
   ...
   static final boolean method582(int var0, int var1, int var2, boolean var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      try {
         return Class102.aClass140_Sub4_Sub1_2141.getSize((byte)114) != var5?(Class102.aClass140_Sub4_Sub1_2141.getSize((byte)114) <= 2?Class158_Sub1.method2191(var6, var4, var11, -1001, var10, var9, var2, var1, var3, var8, var0, var7):Class52.method1166(var10, (byte)34, var7, var9, var1, Class102.aClass140_Sub4_Sub1_2141.getSize((byte)114), var6, var8, var4, var11, var2, var3, var0)):Class2.method76(var7, var8, var4, var0, var10, var3, var2, var1, var6, var9, 127, var11);
