...
final class RSString implements Interface3 {
   ...
   static RSString aClass94_2149 = Class3_Sub4.createRSString("Bitte warten Sie )2 es wird versucht)1 die Verbindung wiederherzustellen)3", (byte)-118);
   static boolean aBoolean2150;
   private boolean aBoolean2152 = true;
   byte[] aByteArray2153; //byteArray in Kratos
   static boolean aBoolean2154;
   static RSString aClass94_2155 = Class3_Sub4.createRSString(":allyreq:", (byte)-127);
   int anInt2156;
   static int[] anIntArray2157 = new int[50];
   private static RSString aClass94_2158 = Class3_Sub4.createRSString("Allocated memory", (byte)-120);
   ...
   static final boolean method1529(int var0, int var1, int var2, int var3, int var4, int var5, int var6, boolean var7) {
      try {
         ...
         if(var8 != 0L) {
            ...
            ObjectDefinition var18 = Class162.method2207(4, var11);
   ...
   static final Class109_Sub1 method1539(int var0, boolean var1, int var2, CacheIndex var3) {
      try {
         if(!var1) {
   ...
   //Commented out, we use Kratos RSString toString
   ...
   //This is Kratos RSString toString
   public final String toString() {
        if (aByteArray2153 == null) {
            throw new RuntimeException();
        }
        return new String(aByteArray2153);
    }
   ...
   static final Class3_Sub28_Sub16 method1570(int var0, byte var1, boolean var2, int var3, boolean var4, int var5, int var6, boolean var7) {
      try {
         ...
         if(null == var21) {
            ...
            return (Class3_Sub28_Sub16)(Class138.highDetail && !var2?new Class3_Sub28_Sub16_Sub1(var15):var15);
         }
