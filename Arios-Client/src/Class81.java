...
final class Class81 {
   ...
   static RSString aClass94_1140 = Class3_Sub4.createRSString(" steht bereits auf Ihrer Ignorieren)2Liste(Q", (byte)-119);
   static int anInt1141;
   static int[][][] anIntArrayArrayArray1142;
   static RSString aClass94_1143 = Class3_Sub4.createRSString("Chargement du module texte )2 ", (byte)-120);
            ...
            if(Class3_Sub28_Sub5.anInt3591 < 100) {
               ...
               for(var5 = 0; ~Class3_Sub28_Sub5.anInt3591 < ~var5; ++var5) {
                  if(Class114.aLongArray1574[var5] == var1) {
                     Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, RenderAnimationDefinition.method903(new RSString[]{var4, Class3_Sub13_Sub25.aClass94_3311}, (byte)-108), -1);
                     return;
                  }
               }
               ...
               for(var5 = 0; Class8.anInt104 > var5; ++var5) {
                  if(~Class50.aLongArray826[var5] == ~var1) {
                     Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, RenderAnimationDefinition.method903(new RSString[]{Class38.aClass94_666, var4, Class3_Sub28_Sub10_Sub2.aClass94_4071}, (byte)-65), -1);
                     return;
                  }
               }

               if(var4.method1528((byte)-42, Class102.aClass140_Sub4_Sub1_2141.displayName)) {
