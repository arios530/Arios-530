...
final class Class128 {
   ...
   private static RSString aClass94_1686 = Class3_Sub4.createRSString("shake:", (byte)-117);
   static RSString aClass94_1687 = Class3_Sub4.createRSString("(Z", (byte)-124);
   ...
   static final Class140_Sub1 method1763(boolean var0, int var1, int var2, int var3, int var4, Class140_Sub1 var5, int var6) {
      try {
         long var7 = (long)var3;
         Class140_Sub1 var9 = (Class140_Sub1)Class61.aClass93_939.get(var7, (byte)121);
         if(var9 == null) {
