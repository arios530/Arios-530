...
final class Class3_Sub28_Sub14 extends Node {
   ...
   static RSString aClass94_3672 = Class3_Sub4.createRSString("", (byte)-117);
   ...
   static final void method628(int var0, int var1, int var2, Player var3) {
      try {
         ...
         if(~var2 == ~var3.anInt2771 && 0 != ~var2) {
            Class142 var4 = client.method45(var2, (byte)-20);
            ...
            if(1 == var5) {
               ...
               var3.anInt2832 = 0;
               var3.anInt2773 = 0;
               IOHandler.method1470(var3.anInt2829, var4, var0 + 183921384, var3.anInt2819, Class102.aClass140_Sub4_Sub1_2141 == var3, var3.anInt2832);
            }

            if(var5 == 2) {
               var3.anInt2773 = 0;
            }
         } else if(-1 == var2 || var3.anInt2771 == -1 || client.method45(var2, (byte)-20).anInt1857 >= client.method45(var3.anInt2771, (byte)-20).anInt1857) {
            var3.anInt2776 = 1;
            var3.anInt2832 = 0;
            var3.anInt2828 = var1;
            ...
            var3.anInt2771 = var2;
            if(var3.anInt2771 != -1) {
               IOHandler.method1470(var3.anInt2829, client.method45(var3.anInt2771, (byte)-20), 183921384, var3.anInt2819, var3 == Class102.aClass140_Sub4_Sub1_2141, var3.anInt2832);
            }
         }
