...
final class Class3_Sub30_Sub1 extends RSByteBuffer {
	...
	static RSString aClass94_3807 = Class3_Sub4.createRSString("m", (byte)-121);

	static final void sendMessage(RSString var0, int var1, RSString var2, int var3) {
		method805(var0, var1, var2, var3);
	}

	static final void method805(RSString var0, int var1, RSString var2, int var3) {
		try {
			Class3_Sub28_Sub12.method611(var3, var1, var2, (RSString)null, (byte)50, var0);
			...
			if(-1 >= ~var1) {
				...
				if(~var4 == -1007) {
					...
					if(null != var13 && ~var13.anIntArray317[var2] <= -100001) {
						method805(Class3_Sub28_Sub14.aClass94_3672, 0, RenderAnimationDefinition.method903(new RSString[]{Class72.method1298((byte)9, var13.anIntArray317[var2]), Class3_Sub28_Sub19.aClass94_3777, Class38.getItemDefinition(var5, (byte)125).name}, (byte)-84), -1);
					} else {
						Class3_Sub13_Sub1.outgoingBuffer.putOpcode(92);
						++Class130.anInt1701;
						Class3_Sub13_Sub1.outgoingBuffer.putLEShortA(var5);
					...
					if(-1 != ~var5) {
						if(-2 == ~var5) {
							if(0 < Class3_Sub13_Sub26.rights && ObjectDefinition.aBooleanArray1490[82] && ObjectDefinition.aBooleanArray1490[81]) {
								...
								Class3_Sub13_Sub1.outgoingBuffer.putShort(GraphicDefinition.anInt531);
								...
								Class3_Sub13_Sub1.outgoingBuffer.putShort(Class102.aClass140_Sub4_Sub1_2141.anInt2819);
								Class3_Sub13_Sub1.outgoingBuffer.putShort(Class102.aClass140_Sub4_Sub1_2141.anInt2829);
				...
				if(1007 == var4) {
					...
					if(var11 != null) {
						...
						if(null != var9) {
							...
							Class3_Sub13_Sub1.outgoingBuffer.putShort(var9.anInt1284);
						}
					}
				}
				...
				if(32 == var4) {
					...
					if(null != var13) {
						...
						if(var13.aBoolean233) {
							Class40.aClass94_676 = RenderAnimationDefinition.method903(new RSString[]{var13.aClass94_277, Class3_Sub26.aClass94_2562}, (byte)-83);
						} else {
							Class40.aClass94_676 = RenderAnimationDefinition.method903(new RSString[]{Class19.aClass94_431, var13.aClass94_243, Class3_Sub26.aClass94_2562}, (byte)-94);
						}
					}
					...
					if(var4 != 22) {
						...
						RenderAnimationDefinition.aClass94_378 = RenderAnimationDefinition.method903(new RSString[]{Class3_Sub13_Sub2.aClass94_3042, Class38.getItemDefinition(var5, (byte)109).name, Class3_Sub26.aClass94_2562}, (byte)-113);
	...
	final void method811(byte var1, int var2, byte[] var3, int var4) {
		try {
			if(var1 < 16) {
				method805((RSString)null, 126, (RSString)null, -28);
			}
	...
	final void putOpcode(int opcode) {
		if (buffer == null || isaacCipher == null) {
            System.err.println("Null buffer opcode " + opcode);
			...
			if(!var0) {
				for(; var1 != null; var1 = (Class3_Sub31)Class3_Sub13_Sub17.aClass130_3208.method1778(-76)) {
					...
					if(Canvas_Sub2.method57(var2, 104)) {
						boolean var3 = true;
						RSInterface[] var4 = Class140.aClass11ArrayArray1834[var2];
