...
final class Class17 {
   ...
   static int anInt410;
   static int anInt411;
   static RSString aClass94_412 = Class3_Sub4.createRSString("Vous ne pouvez pas ajouter votre nom -9 votre liste d(Wamis)3", (byte)-119);
   static Class64 aClass64_413;
   static RSString aClass94_414 = Class3_Sub4.createRSString("Verbindung abgebrochen)3", (byte)-126);
   static RSString aClass94_415 = Class3_Sub4.createRSString("comp-Btence ", (byte)-118);
