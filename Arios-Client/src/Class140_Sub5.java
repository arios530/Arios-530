...
final class Class140_Sub5 extends Class140 {
   ...
   final Class140 method1861(int var1, int var2, int var3) {
      return this.method2008(this.aShort2879, this.aShort2876, var1, var2, var3);
   }

   private final int method1995(Class140_Sub5 var1, int var2, short var3) {
   ...
   final Class140_Sub5 method1999(int var1, int var2, int[][] var3, int[][] var4, int var5, int var6, int var7, boolean var8, boolean var9) {
      this.method1993();
   ...
   private final void method2003(byte[] var1) {
      ...
      if(var11 > 0) {
         ...
         for(var28 = 0; var28 < var11; ++var28) {
            byte var29 = this.aByteArray2857[var28] = var2.getByte(false);
            if(var29 == 0) {
               ++var25;
            }
      ...
      for(var53 = 0; var53 < var9; ++var53) {
         ...
         var55 = 0;
         if((var54 & 1) != 0) {
            var55 = var3.method797(-21208);
         }

         var56 = 0;
         if((var54 & 2) != 0) {
            var56 = var4.method797(-21208);
         }

         var57 = 0;
         if((var54 & 4) != 0) {
            var57 = var5.method797(-21208);
         }
      ...
      for(var53 = 0; var53 < var10; ++var53) {
         ...
         if(var13) {
            this.aByteArray2859[var53] = var3.getByte(false);
         }

         if(var15 == 255) {
            this.aByteArray2889[var53] = var4.getByte(false);
         }

         if(var16 == 1) {
            this.aByteArray2843[var53] = var5.getByte(false);
         }
      ...
      for(var57 = 0; var57 < var10; ++var57) {
         ...
         if(var58 == 1) {
            var53 = var2.method797(-21208) + var56;
            var54 = var2.method797(-21208) + var53;
            var55 = var2.method797(-21208) + var54;
            var56 = var55;
         ...
         if(var58 == 2) {
            var54 = var55;
            var55 = var2.method797(-21208) + var56;
            var56 = var55;
            this.anIntArray2865[var57] = var53;
            this.anIntArray2878[var57] = var54;
            this.anIntArray2864[var57] = var55;
      ...
      for(var57 = 0; var57 < var11; ++var57) {
         ...
         if(var58 == 1) {
            ...
            this.aByteArray2845[var57] = var5.getByte(false);
            this.aByteArray2867[var57] = var6.getByte(false);
            this.aByteArray2877[var57] = var7.getByte(false);
         }
         ...
         if(var58 == 2) {
            ...
            this.aByteArray2867[var57] = var6.getByte(false);
            this.aByteArray2877[var57] = var7.getByte(false);
            this.aByteArray2852[var57] = var7.getByte(false);
            this.aByteArray2869[var57] = var7.getByte(false);
         }
   ...
   final Class140_Sub5 method2004() {
      Class140_Sub5 var1 = new Class140_Sub5();
      if(this.aByteArray2859 != null) {
   ...
   final Class140_Sub1 method2008(int var1, int var2, int var3, int var4, int var5) {
   ...
   final void method1866(Class140 var1, int var2, int var3, int var4, boolean var5) {
      Class140_Sub5 var6 = (Class140_Sub5)var1;
      var6.method1993();
      var6.method1997();
      ++anInt2868;
      int var7 = 0;
   ...
   static final Class140_Sub5 method2015(CacheIndex var0, int var1, int var2) {
      byte[] var3 = var0.getFile(var1, (byte)-122, var2);
      return var3 == null?null:new Class140_Sub5(var3);
   }
   ...
   private final void method2017(byte[] var1) {
      ...
      for(var38 = 0; var38 < var9; ++var38) {
         ...
         var40 = 0;
         if((var39 & 1) != 0) {
            var40 = var5.method797(-21208);
         }

         var41 = 0;
         if((var39 & 2) != 0) {
            var41 = var6.method797(-21208);
         }

         var42 = 0;
         if((var39 & 4) != 0) {
            var42 = var7.method797(-21208);
         }
      ...
      for(var38 = 0; var38 < var10; ++var38) {
         ...
         if(var13 == 255) {
            this.aByteArray2889[var38] = var6.getByte(false);
         }

         if(var14 == 1) {
            this.aByteArray2843[var38] = var7.getByte(false);
         }
      ...
      for(var42 = 0; var42 < var10; ++var42) {
         ...
         if(var43 == 1) {
            var38 = var4.method797(-21208) + var41;
            var39 = var4.method797(-21208) + var38;
            var40 = var4.method797(-21208) + var39;
            var41 = var40;
         ...
         if(var43 == 2) {
            var39 = var40;
            var40 = var4.method797(-21208) + var41;
            var41 = var40;
            this.anIntArray2865[var42] = var38;
            this.anIntArray2878[var42] = var39;
            this.anIntArray2864[var42] = var40;
   ...
   private Class140_Sub5() {}

   private Class140_Sub5(byte[] var1) {
   ...
   Class140_Sub5(int var1, int var2, int var3) {
   ...
   Class140_Sub5(Class140_Sub5[] var1, int var2) {
      boolean var3 = false;
      boolean var4 = false;
      boolean var5 = false;
      boolean var6 = false;
      ...
      for(var11 = 0; var11 < var2; ++var11) {
         Class140_Sub5 var12 = var1[var11];
         if(var12 != null) {
      ...
      for(var11 = 0; var11 < var2; ++var11) {
         ...
         Class140_Sub5 var13 = var1[var11];
         if(var13 != null) {
            int var14;
   ...
   Class140_Sub5(Class140_Sub5 var1, boolean var2, boolean var3, boolean var4, boolean var5) {
