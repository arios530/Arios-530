...
class Class163 {
   ...
   static RSString aClass94_2042 = Class3_Sub4.createRSString("Spieler kann nicht gefunden werden: ", (byte)-120);
   static int[] anIntArray2043 = new int[]{8, 11, 4, 6, 9, 7, 10, 0};
   static RSString aClass94_2044 = Class3_Sub4.createRSString("cookieprefix", (byte)-118);
   static RSString aClass94_2045 = Class3_Sub4.createRSString("::errortest", (byte)-123);
