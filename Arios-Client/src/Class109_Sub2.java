...
final class Class109_Sub2 extends Class109 {
   ...
   private final void method1678(byte[] var1, int[] var2) {
      ...
      Class138.method1850(this.anInt2675);
      var11.glTexImage2D(3553, 0, 6408, this.anInt2681, this.anInt2680, 0, 6408, 5121, var10);
      Class31.anInt584 += var10.limit() - this.anInt2678;
      this.anInt2678 = var10.limit();
   }
   ...
   Class109_Sub2(int var1, int var2, int var3, int var4, int var5, int var6, byte[] var7, int[] var8) {
      this.anInt1469 = var1;
      this.anInt1467 = var2;
      this.anInt1470 = var3;
      this.anInt1464 = var4;
