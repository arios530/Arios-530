...
final class Canvas_Sub2 extends Canvas {
   ...
   static int anInt27;
   static RSString aClass94_28 = Class3_Sub4.createRSString("; Expires=Thu)1 01)2Jan)21970 00:00:00 GMT; Max)2Age=0", (byte)-128);
   static boolean aBoolean29 = false;
   static int anInt30;
   static int anInt31 = 0;
   
   private Component aComponent33;
   private static RSString aClass94_34 = Class3_Sub4.createRSString("flash2:", (byte)-128);
   static RSString aClass94_32 = aClass94_34;
   static RSString aClass94_35 = Class3_Sub4.createRSString("Annuler", (byte)-121);
            ...
            if(Class3_Sub13_Sub29.aClass153_3361.method2117(-99, var0)) {
               ...
               if(0 == var2) {
                  ...
                  if(null == Class140.aClass11ArrayArray1834[var0]) {
                     Class140.aClass11ArrayArray1834[var0] = new RSInterface[var2];
                  }

                  for(int var3 = 0; var3 < var2; ++var3) {
                     if(null == Class140.aClass11ArrayArray1834[var0][var3]) {
                        byte[] var4 = Class3_Sub13_Sub29.aClass153_3361.getFile(var0, (byte)-122, var3);
                        if(var4 != null) {
                           RSInterface var5 = Class140.aClass11ArrayArray1834[var0][var3] = new RSInterface();
                           var5.anInt279 = var3 + (var0 << 16);
                           if(-1 == var4[0]) {
                              var5.method867(var1 ^ -105, new RSByteBuffer(var4));
                           } else {
                              var5.method858(-115, new RSByteBuffer(var4));
                           }
                        }
                     }
                  }
      ...
      try {
         ...
         while(~var25.buffer.length < ~var25.index) {
            ...
            for(var15 = 0; var15 < 4; ++var15) {
               byte var16 = var25.getByte(false);
               int var18;
               if(var16 != 0) {
                  if(~var16 == -2) {
                     for(var17 = 0; 64 > var17; var17 += 4) {
                        for(var18 = 0; -65 < ~var18; var18 += 4) {
                           byte var19 = var25.getByte(false);
                           if(~var15 >= ~var7) {
