...
final class Class102 implements Interface2 {
   ...
   static RSString aClass94_2132 = Class3_Sub4.createRSString("Titelbild ge-Offnet)3", (byte)-118);
   ...
   static Player aClass140_Sub4_Sub1_2141;
   ...
   static final void method1611(int var0, boolean var1) {
      try {
         ...
         for(var2 = 0; var2 < Class163.localNPCCount; ++var2) {
            ...
            if(null != var3 && var3.method1966((byte)17) && !var3.definition.aBoolean1263 != var1 && var3.definition.method1472((byte)74)) {
         ...
         for(var2 = 0; ~var2 > ~Class163.localNPCCount; ++var2) {
            ...
            if(var3 != null && var3.method1966((byte)17) && !var3.definition.aBoolean1263 == !var1 && var3.definition.method1472((byte)74)) {
   ...
   final void method1619(int var1, int var2) {
      try {
         if(var2 != -1) {
            aClass140_Sub4_Sub1_2141 = (Player)null;
         }
   ...
   Class102(CacheIndex var1, CacheIndex var2, CacheIndex var3, int var4, boolean var5) {
      try {
         ...
         for(var8 = 0; var7 > var8; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aByteArray2126[var8] = var6.getByte(false);
            }
         }

         for(var8 = 0; var7 > var8; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aByteArray2129[var8] = var6.getByte(false);
            }
         }

         for(var8 = 0; var8 < var7; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aByteArray2144[var8] = var6.getByte(false);
            }
         }

         for(var8 = 0; ~var8 > ~var7; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aByteArray2143[var8] = var6.getByte(false);
            }
         }
