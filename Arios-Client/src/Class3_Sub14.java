...
final class Class3_Sub14 extends Class3 {
   ...
   private final void method360(byte[] var1) {
      ...
      this.anInt2408 = var2.getInt(-502942936);
      this.anInt2390 = var2.getInt(-502942936);
      this.anInt2397 = var2.getInt(-502942936);
      this.anInt2401 = var2.getInt(-502942936);
      if(this.anInt2401 < 0) {
         this.anInt2401 = ~this.anInt2401;
         this.aBoolean2395 = true;
      }

      int var3 = var2.getInt(-502942936);
