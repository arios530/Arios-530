...
final class Class3_Sub28_Sub8 extends Node {
   ...
   static final Class3_Sub28_Sub15 method572(int var0, byte var1) {
      try {
         ...
         if(var2 != null) {
            ...
            byte[] var3 = Class3_Sub1.aClass153_2203.getFile(var0, (byte)-122, 0);
            if(var3 != null) {
               ...
               var4.index = var6;
               int var7 = var4.getInt(-502942936);
               ...
               if(var8 > 0) {
                  ...
                  for(var9 = 0; var9 < var8; ++var9) {
                     ...
                     while(-1 > ~(var10--)) {
                        int var12 = var4.getInt(-502942936);
                        int var13 = var4.getInt(-502942936);
               ...
               for(var2.anIntArray3690 = new int[var7]; ~var6 < ~var4.index; var2.anIntArray3683[var9++] = var10) {
                  ...
                  if(var10 != 3) {
                     if(var10 < 100 && 21 != var10 && -39 != ~var10 && 39 != var10) {
                        var2.anIntArray3690[var9] = var4.getInt(-502942936);
                     } else {
   ...
   static final void method574(NPC var0, boolean var1) {
      try {
         if(!var1) {
            for(Class3_Sub9 var2 = (Class3_Sub9)IOHandler.aClass61_1242.method1222(-71); var2 != null; var2 = (Class3_Sub9)IOHandler.aClass61_1242.method1221(4)) {
