...
final class Class96 {
   ...
   int anInt1346;
   int anInt1347;
   static RSString aClass94_1348 = Class3_Sub4.createRSString("Kampfstufe: ", (byte)-123);
   static RSString aClass94_1349 = Class3_Sub4.createRSString("underlay", (byte)-123);
   int anInt1350;
   int anInt1351;
                        ...
                        if(!var18 || ~(8 * var5) >= ~var13 && ~var13 > ~(8 * var5 - -8) && ~var14 <= ~(8 * var6) && var14 < var6 * 8 - -8) {
                           ...
                           if(0 != var15) {
                              ...
                              if(4 == (var15 & 4)) {
                                 ...
                                 --var2;
                                 ObjectDefinition var3 = Class162.method2207(4, var2);
