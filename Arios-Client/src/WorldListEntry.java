...
final class WorldListEntry extends Class44 {
   ...
   private static RSString aClass94_2619 = Class3_Sub4.createRSString("Loaded update list", (byte)-123);
   RSString activity;
   int worldId;
   ...
   static RSString aClass94_2628 = Class3_Sub4.createRSString("Stufe: ", (byte)-122);
