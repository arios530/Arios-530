...
final class Class3_Sub28_Sub13 extends Node {
   ...
   static RSString aClass94_3661 = Class3_Sub4.createRSString("T", (byte)-128);
   int anInt3662;
               ...
               if(var1 != 4) {
                  if(5 == var1 || -7 == ~var1) {
                     ...
                     for(int var5 = 0; var5 < var4; ++var5) {
                        int var6 = var2.getInt(-502942936);
                        Object var7;
                        if(~var1 == -6) {
                           var7 = new Class3_Sub29(var2.getString());
                        } else {
                           var7 = new Class3_Sub18(var2.getInt(-502942936));
                        }
                  ...
                  this.anInt3667 = var2.getInt(-502942936);
               }
            } else {
   ...
   static final Class109_Sub1[] method619(byte var0, int var1, CacheIndex var2) {
      try {
   ...
   static final byte[] method623(byte var0, byte[] var1) {
      try {
         ...
         int var4 = var2.getInt(-502942936);
         if(0 <= var4 && (-1 == ~Class75.anInt1108 || ~Class75.anInt1108 <= ~var4)) {
            if(-1 == ~var3) {
               ...
               int var5 = var2.getInt(-502942936);
