...
final class Class154 {
   ...
   private static RSString aClass94_1958 = Class3_Sub4.createRSString("Please wait )2 attempting to reestablish)3", (byte)-125);
   static RSString aClass94_1959 = aClass94_1958;
   static int[] anIntArray1960 = new int[14];
   
   private static RSString aClass94_1963 = Class3_Sub4.createRSString("glow2:", (byte)-127);
