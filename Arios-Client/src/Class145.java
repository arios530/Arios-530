...
final class Class145 {
   ...
   static RSString aClass94_1889 = Class3_Sub4.createRSString("blinken2:", (byte)-125);
   int anInt1890;
   int anInt1891;
   ...
   private static RSString aClass94_1899 = Class3_Sub4.createRSString("Loading textures )2 ", (byte)-124);
   int anInt1900;
            ...
            if(var2.aBoolean2222) {
               ...
               if(var22) {
                  ...
                  if(var24 != null && (var24.aLong328 & 2147483648L) != 0L) {
                     if(Class138.highDetail && var24.aBoolean329) {
               ...
               if(var22) {
                  ...
                  if(var30 != null && (var30.aLong328 & 2147483648L) == 0L) {
                     if(Class138.highDetail && var30.aBoolean329) {
                        Class138.method1832(var8 + 50.0F - 1.5F);
                     }
