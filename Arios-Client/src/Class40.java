...
final class Class40 {
   ...
   static RSString aClass94_672 = Class3_Sub4.createRSString("null", (byte)-122);
   static RSString aClass94_673 = Class3_Sub4.createRSString(")0", (byte)-121);
   static int anInt674;
   ...
   public static final int MAXIMUM_RENDER_DISTANCE_GPU = 56;
   public static final int MAXIMUM_RENDER_DISTANCE = 40;
   public static final int MINIMUM_RENDER_DISTANCE = 10;
   public static int render_distance = MAXIMUM_RENDER_DISTANCE;
   ...
   static final Class3_Sub28_Sub16_Sub2 method1043(int var0, CacheIndex var1, int var2, int var3) {
      try {
         if(var2 != -3178) {
            method1044(-55);
         }
      ...
      try {
         ...
         for(var2 = 0; ~var2 > ~Class164_Sub2.aByteArrayArray3027.length; ++var2) {
            ...
            if(-1 != Class101.anIntArray1426[var2] && null == Class3_Sub22.aByteArrayArray2521[var2]) {
               Class3_Sub22.aByteArrayArray2521[var2] = Class3_Sub13_Sub6.aClass153_3077.method2126(Class101.anIntArray1426[var2], Class3_Sub9.regionXteaKeys[var2], 37, 0);
            ...
            if(null != Class3_Sub13_Sub24.anIntArray3290 && null == Class3_Sub13_Sub26.aByteArrayArray3335[var2] && Class3_Sub13_Sub24.anIntArray3290[var2] != -1) {
               Class3_Sub13_Sub26.aByteArrayArray3335[var2] = Class3_Sub13_Sub6.aClass153_3077.method2126(Class3_Sub13_Sub24.anIntArray3290[var2], Class3_Sub9.regionXteaKeys[var2], 92, 0);
         ...
         if(!var1) {
            ...
            for(var2 = 0; ~Class164_Sub2.aByteArrayArray3027.length < ~var2; ++var2) {
               ...
               if(null != var3) {
                  ...
                  var1 &= Class24.parseObjectMapping((byte)-97, var4, var5, var3);
               }
               ...
               if(Class138.highDetail) {
                  ...
                  if(null != var3) {
                     ...
                     var1 &= Class24.parseObjectMapping((byte)-74, var4, var5, var3);
                  }
               }
            }
            ...
            if(!var1) {
               ...
               boolean var11 = false;
               int var12;
               if(Class138.highDetail && Class128.aBoolean1685) {
               ...
               Class3_Sub4.method110(4, 104, 104, render_distance, var11); //Render/Draw distance is 28 and 25
