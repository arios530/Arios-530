...
final class Class3_Sub13_Sub13 extends Class3_Sub13 {
   ...
   static RSString aClass94_3146 = Class3_Sub4.createRSString(" s(West connect-B)3", (byte)-128);
   private int anInt3147 = 4;
   static int anInt3148 = 0;
   private int anInt3149 = 4;
   static RSString aClass94_3150 = Class3_Sub4.createRSString("null", (byte)-123);
   static int anInt3151;
   static RSString aClass94_3152 = Class3_Sub4.createRSString("::gc", (byte)-120);
   static int anInt3153;
   static CacheIndex aClass153_3154;
   static int anInt3155;
   static int anInt3156 = -1;
   static RSString aClass94_3157 = Class3_Sub4.createRSString(" est d-Bj-9 dans votre liste noire)3", (byte)-124);
   ...
   static final void method232(int var0, int var1) {
      try {
         if(Canvas_Sub2.method57(var0, 104)) {
            RSInterface[] var2 = Class140.aClass11ArrayArray1834[var0];
   ...
   static final void method233(int var0, CacheIndex var1) {
      try {
         ...
         NPC.anInt4001 = var1.method2120(Class9.aClass94_119, (byte)-30);
      } catch (RuntimeException var3) {
         ...
         if(Class3_Sub28_Sub18.aBoolean3769) {
            ...
            if(Class143.anInt1875 == 30) {
               ...
               if(Class3_Sub28_Sub10_Sub2.aBoolean4068 && 0 >= Class3_Sub1.anInt2212) {
                  ...
                  Class3_Sub13_Sub1.outgoingBuffer.putLEShort(-1, GraphicDefinition.anInt531);
               }
               ...
               if(Class143.anInt1875 == 30) {
                  ...
                  if(Class3_Sub28_Sub16.anInt3699 > 750) {
                     ...
                     while(true) {
                           ...
                           while(true) {
                              ...
                              if(var26 == null) {
                                 while(true) {
                                    ...
                                    if(-1 >= ~var25.anInt191) {
                                       var23 = Class7.getRSInterface((byte)118, var25.anInt190);
                              ...
                              var25 = var26.aClass11_2449;
                              if(~var25.anInt191 <= -1) {
                                 var23 = Class7.getRSInterface((byte)120, var25.anInt190);
                        ...
                        var25 = var26.aClass11_2449;
                        if(var25.anInt191 >= 0) {
                           var23 = Class7.getRSInterface((byte)127, var25.anInt190);
