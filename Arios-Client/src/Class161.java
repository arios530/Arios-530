...
final class Class161 {
   ...
   static RSString aClass94_2025 = Class3_Sub4.createRSString(")2", (byte)-122);
   static int[] anIntArray2026;
   static int anInt2027 = -1;
   static int anInt2028 = 0;
   static RSString aClass94_2029 = Class3_Sub4.createRSString("l", (byte)-125);
   static RSByteBuffer aClass3_Sub30_2030 = new RSByteBuffer(new byte[5000]);
   
   private static RSString aClass94_2032 = Class3_Sub4.createRSString("Cancel", (byte)-120);
   static RSString aClass94_2033 = Class3_Sub4.createRSString("Memory after cleanup=", (byte)-118);
