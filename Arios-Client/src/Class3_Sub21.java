...
final class Class3_Sub21 extends Class3 {
   ...
   int anInt2494;
   int anInt2495;
   static RSString aClass94_2496 = Class3_Sub4.createRSString("scrollen:", (byte)-126);
   int anInt2497;
   static RSString aClass94_2498 = Class3_Sub4.createRSString("(U (X", (byte)-124);
