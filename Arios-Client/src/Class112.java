...
final class Class112 implements Interface5 {
   ...
   public final void method21() {
      Class138.aGL1804.glCallList(this.anInt2177 + 1);
   }
   ...
   public final void method23(int var1) {
      ...
      if((var1 & 1) == 1) {
         if(Class88.aBoolean1227) {
            if(this.anInt2181 != Class138.anInt1791) {
               this.aFloatArray2179[0] = 0.0F;
               this.aFloatArray2179[1] = 0.0F;
               this.aFloatArray2179[2] = 0.0F;
               this.aFloatArray2179[3] = (float)Class138.anInt1791 * 0.0050F;
               var2.glTexGenfv(8194, 9473, this.aFloatArray2179, 0);
               this.anInt2181 = Class138.anInt1791;
            }
         } else {
            Class138.method1850(Class88.anIntArray1224[Class138.anInt1791 * 64 / 100 % 64]);
         }
         ...
         Class138.method1850(Class88.anIntArray1224[0]);
      }
   ...
   public final void method22() {
      GL2 var1 = Class138.aGL1804;
      Class138.method1856(2);
      Class138.method1847(2);
      Class138.method1823();
      var1.glCallList(this.anInt2177);
      float var2 = 2662.4001F;
      var2 += (float)(Class140_Sub7.anInt2938 - 128) * 0.5F;
      float max = (float) (Class40.render_distance * 128) - (((float) Class40.render_distance / 28.0f) * 256.0f);
      if (var2 >= max) {
	     var2 = max - 1.0f;
	  }
      ...
      this.aFloatArray2179[0] = 0.0F;
      this.aFloatArray2179[1] = 0.0F;
      this.aFloatArray2179[2] = 1.0F / (var2 - max);
      this.aFloatArray2179[3] = var2 / (var2 - max);
