...
class Node extends Class3 {
   ...
   private static RSString aClass94_2568 = Class3_Sub4.createRSString("Started 3d Library", (byte)-128);
   long aLong2569;
   ...
   static final NPCDefinition method522(int var0, int var1) {
      try {
         NPCDefinition var2 = (NPCDefinition)Class3_Sub28_Sub7_Sub1.aClass93_4043.get((long)var0, (byte)121);
         if(null == var2) {
            ...
            var2.anInt1284 = var0;
            if(null != var3) {
               var2.method1478(new RSByteBuffer(var3), 74);
            }

            var2.method1481(98);
            Class3_Sub28_Sub7_Sub1.aClass93_4043.put((byte)-95, var2, (long)var0);
            return var2;
         } else {
            return var2;
         }
