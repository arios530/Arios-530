...
final class Class3_Sub13_Sub25 extends Class3_Sub13 {
   ...
   static RSString aClass94_3302 = Class3_Sub4.createRSString("Connexion perdue)3", (byte)-122);
   private int anInt3303 = 1024;
   static CacheIndex aClass153_3304;
   static int loginStage = 0;
   private static RSString aClass94_3306 = Class3_Sub4.createRSString(" is already on your ignore list)3", (byte)-126);
   static RSString aClass94_3307 = Class3_Sub4.createRSString("<col=00ff80>", (byte)-125);
