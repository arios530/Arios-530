...
final class Class86 {
   ...
   int anInt1175;
   private static RSString aClass94_1176 = Class3_Sub4.createRSString("Loading wordpack )2 ", (byte)-120);
   int anInt1177;
   int anInt1178;
   static RSString aClass94_1179 = Class3_Sub4.createRSString("Veuillez patienter)3)3)3", (byte)-118);
   ...
   float aFloat1187;
   static RSString aClass94_1188 = Class3_Sub4.createRSString("::rebuild", (byte)-124);
   float aFloat1189;
   float aFloat1190;
   static int anInt1191;
   private static RSString aClass94_1192 = Class3_Sub4.createRSString("Examine", (byte)-121);
   ...
   Class86(RSByteBuffer var1) {
      try {
         ...
         if(~(var2 & 1) == -1) {
            ...
            this.anInt1177 = var1.getInt(-502942936);
         }
         ...
         if((32 & var2) == 0) {
            ...
            this.anInt1175 = var1.getInt(-502942936);
         }
