...
final class Class24 {
   ...
   static RSString aClass94_463 = Class3_Sub4.createRSString("Bitte entfernen Sie ", (byte)-122);
   private short[] aShortArray464;
   static RSString aClass94_465 = Class3_Sub4.createRSString(" ", (byte)-117);
   int anInt466 = -1;
   static int anInt467 = 0;
   static RSString aClass94_468 = Class3_Sub4.createRSString("(U", (byte)-125);
   static int anInt469 = 0;
   private short[] aShortArray470;
   private short[] aShortArray471;
   static int anInt472 = 0;
   private static RSString aClass94_473 = Class3_Sub4.createRSString("Loading title screen )2 ", (byte)-127);
   private int[] anIntArray474;
   private int[] anIntArray475 = new int[]{-1, -1, -1, -1, -1};
   boolean aBoolean476 = false;
   private static RSString aClass94_477 = Class3_Sub4.createRSString("Loading)3)3)3", (byte)-118);
 static RSString aClass94_461 = aClass94_473;
   ...
   static final boolean parseObjectMapping(byte var0, int var1, int var2, byte[] var3) {
      try {
            ...
            while(true) {
               ...
               if(!var10) {
                  ...
                  if(~var15 < -1 && var16 > 0 && 103 > var15 && 103 > var16) {
                     ObjectDefinition var17 = Class162.method2207(4, var7);
