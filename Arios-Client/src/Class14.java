...
final class Class14 {
   ...
   static RSString aClass94_338 = Class3_Sub4.createRSString("Ablegen", (byte)-117);
   static RSString aClass94_339 = Class3_Sub4.createRSString("1", (byte)-126);
   static int anInt340 = 127;
   static RSString aClass94_341 = Class3_Sub4.createRSString(")3", (byte)-125);


   private static final Class109_Sub1[] method885(boolean var0, int var1, CacheIndex var2, int var3) {
      try {
         if(!var0) {
   ...
   static final void method887(int var0, CacheIndex var1) {
      try {
         ...
         Class66.aClass3_Sub28_Sub16Array996 = Class140_Sub6.method2027(0, (byte)11, client.anInt2195, var1);
         Class3_Sub13_Sub31.aClass3_Sub28_Sub16Array3373 = Class140_Sub6.method2027(0, (byte)11, Node.anInt2575, var1);
         NPC.aClass3_Sub28_Sub16Array3977 = Class140_Sub6.method2027(0, (byte)11, RenderAnimationDefinition.anInt380, var1);
