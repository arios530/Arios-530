...
final class Class75_Sub4 extends Class75 {
   ...
   static RSString aClass94_2662 = Class3_Sub4.createRSString("Zugewiesener Speicher)3", (byte)-123);
   static int[] anIntArray2663;
   static int[] anIntArray2664;
   private static RSString aClass94_2665 = Class3_Sub4.createRSString("Choose Option", (byte)-123);
   private int anInt2666;
   static RSString aClass94_2667 = aClass94_2665;
   static int[] packetSizes = new int[]{-1,
 0,
 8,
 0,
 2,
 ...
 0};
      ...
      try {
         ...
         for(i = 0; Class66.maskUpdateCount > i; ++i) {
            ...
            if(0 != (var4 & 128)) {
               ...
               boolean var7 = true;
               if(0 != ~var5 && 0 != ~npc.anInt2842 && client.method45(RenderAnimationDefinition.getGraphicDefinition((byte)42, var5).anInt542, (byte)-20).anInt1857 < client.method45(RenderAnimationDefinition.getGraphicDefinition((byte)42, npc.anInt2842).anInt542, (byte)-20).anInt1857) {
                  var7 = false;
               }
            ...
            if((1 & var4) != 0) {
               ...
               npc.method1987(-1, Node.method522(GraphicDefinition.incomingBuffer.getLEShort(-84), 27112));
            ...
            if(-1 != ~(var4 & 32)) {
               npc.aClass94_2825 = GraphicDefinition.incomingBuffer.getString();
               npc.anInt2814 = 100;
            }
   ...
   static final boolean method1351(CacheIndex var0, int var1, int var2, int var3) {
      try {
         byte[] var4 = var0.getFile(var2, (byte)-122, var1);
         if(var3 != -30901) {
