...
final class Class133 {
   ...
   static RSString aClass94_1745 = Class3_Sub4.createRSString("settings", (byte)-127);
   int anInt1746;
   int anInt1747;
   ...
   Class133(RSByteBuffer var1) {
      try {
         this.aByte1742 = var1.getByte(false);
         this.anInt1752 = var1.getShort(1);
         this.anInt1757 = var1.getInt(-502942936);
         this.anInt1747 = var1.getInt(-502942936);
         this.anInt1746 = var1.getInt(-502942936);
         this.anInt1750 = var1.getInt(-502942936);
      } catch (RuntimeException var3) {
