...
final class Class151_Sub1 extends Class151 {
   ...
   static RSString aClass94_2945 = Class3_Sub4.createRSString("Votre liste d(Wamis est pleine (X100 noms maximum pour la version gratuite et 200 pour les abonn-Bs(Y)3", (byte)-123);
   ...
   static RSString aClass94_2951 = Class3_Sub4.createRSString("k", (byte)-119);
   ...
   static RSString aClass94_2959 = Class3_Sub4.createRSString("mapfunction", (byte)-126);
   private static RSString aClass94_2960 = Class3_Sub4.createRSString("Loading interfaces )2 ", (byte)-126);
         ...
         if(-1 != ~opcode) {
            ...
            if(0 != type) {
               ...
               if(~type == -2) { //Walk
                  ...
                  Class102.aClass140_Sub4_Sub1_2141.walkStep(1, (byte)-128, var4);
                  ...
                  if(GraphicDefinition.incomingBuffer.getBits((byte)-11, 1) == 1) {
                     var4 = GraphicDefinition.incomingBuffer.getBits((byte)-11, 3);
                     Class102.aClass140_Sub4_Sub1_2141.walkStep(2, (byte)-104, var4);
                     var5 = GraphicDefinition.incomingBuffer.getBits((byte)-11, 3);
                     Class102.aClass140_Sub4_Sub1_2141.walkStep(2, (byte)-126, var5);
                  } else {
                     var4 = GraphicDefinition.incomingBuffer.getBits((byte)-11, 3);
                     Class102.aClass140_Sub4_Sub1_2141.walkStep(0, (byte)-109, var4);
                  }
               ...
               try {
                  if(var5 != null && ~var5.length < -3) {
                     ...
                     if(this.aClass62_2944.anIntArray945[var2] != var7) {
                       	 System.err.println("CRC mismatch -[entry=" + this.aClass62_2944.anIntArray945[var2] + ", pass=" + var7 + "!");
                         throw new RuntimeException();
                     } else {
                        int var8 = (var5[-2 + var5.length] << 8 & '\uff00') - -(255 & var5[-1 + var5.length]);
                        if(~var8 != ~('\uffff' & this.aClass62_2944.anIntArray958[var2])) {
                          	 System.err.println("CRC mismatch -[entry=" + this.aClass62_2944.anIntArray958[var2] + ", pass=" + var8 + "!");
                           throw new RuntimeException();
                        } else {
