...
final class Class3_Sub13_Sub8 extends Class3_Sub13 {
	...
	static RSString aClass94_3106 = Class3_Sub4.createRSString("clignotant2:", (byte)-124);
	...
	static final void method204(int var0) {
		try {
			...
			Class3_Sub13_Sub1.outgoingBuffer.putByte((byte)-66, Class83.getScreenMode(0));
	...
	static final void method205(CacheIndex var0, int var1, CacheIndex var2, Interface4 var3) {
		try {
			...
			if(Class154.aClass153_1967 != null) {
				RenderAnimationDefinition.anInt377 = Class154.aClass153_1967.method2142(1, (byte)83);
			}
