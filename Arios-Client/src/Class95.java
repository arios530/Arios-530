...
final class Class95 {
   ...
   static RSString aClass94_1333 = Class3_Sub4.createRSString("um", (byte)-118);
   private static RSString aClass94_1334 = Class3_Sub4.createRSString("You can(Wt add yourself to your own ignore list)3", (byte)-118);
   static RSString aClass94_1335 = aClass94_1334;
   static int anInt1336 = 0;
   static RSString aClass94_1337 = Class3_Sub4.createRSString("::breakcon", (byte)-118);
   static int anInt1338;
   static Class3_Sub28_Sub16 aClass3_Sub28_Sub16_1339;
   static volatile int anInt1340 = -1;
   static RSString aClass94_1341 = Class3_Sub4.createRSString("logo", (byte)-119);
   static RSString aClass94_1342 = Class3_Sub4.createRSString("details", (byte)-123);
