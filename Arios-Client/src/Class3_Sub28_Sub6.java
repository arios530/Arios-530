...
final class Class3_Sub28_Sub6 extends Node {
   ...
   static RSString aClass94_3595 = Class3_Sub4.createRSString("(U0a )2 via: ", (byte)-127);
   int anInt3596;
   int anInt3597;
   int anInt3598;
   ...
   static final Class109 a(int var0, CacheIndex var1, boolean var2) {
      try {
   ...
   static final void a(int var0, int var1, int var2, int var3, RSString var4, long var5, int var7) {
      try {
         RSByteBuffer var8 = new RSByteBuffer(128);
         var8.putByte((byte)-101, 10);
         var8.putShort((int)(Math.random() * 99999.0D));
         var8.putShort(530);
         var8.putLong(var5, -2037491440);
