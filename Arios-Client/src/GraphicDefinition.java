...
final class GraphicDefinition {
	...
	private static RSString aClass94_553 = Class3_Sub4.createRSString("slide:", (byte)-128);
	static int anInt529;
	private int anInt530 = 128;
	static int anInt531 = 0; //CAMERA_DIRECTION
	static Class3_Sub30_Sub1 incomingBuffer = new Class3_Sub30_Sub1(100_000); //temp - was 5000
	...
	static RSString aClass94_550 = Class3_Sub4.createRSString("Jeter", (byte)-117);
	static RSString aClass94_551 = aClass94_553;
	static RSString aClass94_552 = Class3_Sub4.createRSString("Sprites geladen)3", (byte)-117);
	...
	final Class140_Sub1 method966(int var1, byte var2, int var3, int var4) {
		try {
			Class140_Sub1 var5 = (Class140_Sub1)Class27.aClass93_511.get((long)this.graphicId, (byte)121);
			if(var2 != -30) {
	...
	static final void method967(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		try {
			if(Canvas_Sub2.method57(var5, 104)) {
				if(var2 == 2) {
					client.handleItemSwitch(Class140.aClass11ArrayArray1834[var5], -1, var6, var1, var4, var7, var0, var3);
				}
			}
