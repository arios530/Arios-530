...
final class Class3_Sub22 extends Class3 {
   ...
   static RSString aClass94_2499 = Class3_Sub4.createRSString("Okay", (byte)-117);
   ...
   int anInt2516;
   int anInt2517;
   static RSString aClass94_2518 = Class3_Sub4.createRSString("Poser", (byte)-122);
   int anInt2519;
   int anInt2520;
   static byte[][] aByteArrayArray2521;
   int anInt2522;
   int anInt2523;
   static RSString aClass94_2524 = Class3_Sub4.createRSString("Starte 3D)2Softwarebibliothek)3", (byte)-126);
   private static RSString aClass94_2525 = Class3_Sub4.createRSString("rating: ", (byte)-118);
   ...
   static final void method398(int var0, int var1, int var2, int var3, int var4, byte[][][] var5, int[] var6, int[] var7, int[] var8, int[] var9, int[] var10, int var11, byte var12, int var13, int var14) {
      ...
      if (Class138.highDetail) {
          var15 = Class40.render_distance * 128;
      } else {
          var15 = 3500;
      }
   ...
   static final void method402(int var0) {
      try {
         if(0 != ~Class87.javaVendor.toLowerCase().indexOf("microsoft")) {
   ...
   static void method403() {
      ...
      var0.glFogf(2915, (float) (Class40.render_distance * 128) - ((((float) Class40.render_distance / 28.0f) * 256.0f) * 2.0f));
      Class138.method1851();
