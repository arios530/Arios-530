...
abstract class Class3_Sub28_Sub10 extends Node {
   ...
   private static RSString aClass94_3626 = Class3_Sub4.createRSString("Created gameworld", (byte)-125);
   ...
   static RSString aClass94_3633 = Class3_Sub4.createRSString("Textures charg-Bes", (byte)-125);
   static RSString aClass94_3634 = Class3_Sub4.createRSString("Liste des serveurs charg-Be", (byte)-121);
   ...
   static final boolean method590(byte var0, int var1, int var2) {
      try {
         ...
         ObjectDefinition var4 = Class162.method2207(4, var1);
