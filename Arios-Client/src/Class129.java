...
abstract class Class129 {
   ...
   static RSString aClass94_1694 = Class3_Sub4.createRSString("document)3cookie=(R", (byte)-120);
   static int[] anIntArray1695;
   static RSString aClass94_1696 = Class3_Sub4.createRSString("Sie k-Onnen sich selbst nicht auf Ihre Freunde)2Liste setzen(Q", (byte)-125);
   ...
   static final void method1768(int var0, int var1, int var2) {
      try {
         if(-1 > ~Class148.anInt1908) {
            //further up the stack, this may be better to comment out than in class47.method1095, lets prevent a crash on Ubuntu 16.04 Linux Lenovo T430 laptop so comment this out?
