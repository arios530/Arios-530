...
final class Class130 {
   ...
   public static boolean chatboxOpen = false;

   Class3[] aClass3Array1697;
   static RSString aClass94_1698 = Class3_Sub4.createRSString("(R", (byte)-117);
   static RSString aClass94_1699 = Class3_Sub4.createRSString(" )2> <col=ff9040>", (byte)-117);
   int anInt1700;
   static int anInt1701;
   static RSString aClass94_1702 = Class3_Sub4.createRSString("Hierhin drehen", (byte)-123);
   ...
   private static RSString aClass94_1710 = Class3_Sub4.createRSString("Loaded sprites", (byte)-123);
   ...
   static RSString aClass94_1714 = Class3_Sub4.createRSString("<col=ff7000>", (byte)-128);
   private int anInt1715 = 0;


   static final void method1772(int plane, int var1, int dummy, NPC var3) {
      try {
         if(var3.anInt2771 == var1 && -1 != var1) {
            Class142 var4 = client.method45(var1, (byte)-20);
         ...
         } else if(~var1 == 0 || -1 == var3.anInt2771 || client.method45(var1, (byte)-20).anInt1857 >= client.method45(var3.anInt2771, (byte)-20).anInt1857) {
            var3.anInt2760 = 0;
            var3.anInt2771 = var1;
            var3.anInt2776 = 1;
            var3.anInt2773 = 0;
            ...
            var3.anInt2832 = 0;
            if(var3.anInt2771 != -1) {
               IOHandler.method1470(var3.anInt2829, client.method45(var3.anInt2771, (byte)-20), dummy + 183921345, var3.anInt2819, false, var3.anInt2832);
            }
         }
         ...
         throw Class44.method1067(var6, "sc.J(" + plane + ',' + var1 + ',' + dummy + ',' + (var3 != null?"{...}":"null") + ')');
      }
   }
