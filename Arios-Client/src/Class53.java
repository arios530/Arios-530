...
final class Class53 {
   ...
   static int anInt867;
   static RSString aClass94_868 = Class3_Sub4.createRSString("Chargement de l(W-Bcran)2titre )2 ", (byte)-122);
      ...
      try {
         ...
         if(-360001 <= ~var7) {
            ...
            if(var8 * var8 >= var7) {
               ...
               var8 -= 10;
               int var9 = 2047 & Class3_Sub13_Sub8.anInt3102 + GraphicDefinition.anInt531;
   ...
   static final void parseWorldList(RSByteBuffer buffer, int var1) {
      try {
         ...
         for(var3 = 0; var3 < Class57.activeWorldListSize; ++var3) {
            ...
            var5.settings = buffer.getInt(-502942936);
         ...
         Class3_Sub28_Sub7.updateStamp = buffer.getInt(-502942936);
   ...
   static final RSString method1174(RSInterface var0, byte var1) {
      try {
         ...
         return ~client.method44(var0).method101(-69) != -1?(null != var0.aClass94_245 && var0.aClass94_245.method1564(1).length(-45) != 0?var0.aClass94_245:(Class69.aBoolean1040?RuntimeException_Sub1.aClass94_2116:null)):null;
      } catch (RuntimeException var3) {
