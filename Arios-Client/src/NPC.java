...
final class NPC extends Class140_Sub4 {
	...
	private static RSString aClass94_3978 = Class3_Sub4.createRSString("Dec", (byte)-117);
	static float aFloat3979;
	private static RSString aClass94_3980 = Class3_Sub4.createRSString("Jul", (byte)-126);
	private static RSString aClass94_3982 = Class3_Sub4.createRSString("May", (byte)-125);
	private static RSString aClass94_3983 = Class3_Sub4.createRSString("Nov", (byte)-126);
	private static RSString aClass94_3984 = Class3_Sub4.createRSString("Mar", (byte)-121);
	static int[] anIntArray3986 = new int[32];
	private static RSString aClass94_3987 = Class3_Sub4.createRSString("flash3:", (byte)-123);
	static RSString aClass94_3988 = aClass94_3987;
	static RSString aClass94_3981 = aClass94_3987;
	private static RSString aClass94_3989 = Class3_Sub4.createRSString("Jan", (byte)-121);
	private static RSString aClass94_3990 = Class3_Sub4.createRSString("Feb", (byte)-124);
	static RSString aClass94_3991 = Class3_Sub4.createRSString("ondulation:", (byte)-117);
	static RSString aClass94_3992 = Class3_Sub4.createRSString("loginscreen", (byte)-128);
	static CacheIndex aClass153_3993;
	static CacheIndex aClass153_3994;
	static int anInt3995;
	private static RSString aClass94_3996 = Class3_Sub4.createRSString("Aug", (byte)-126);
	static int[] anIntArray3997 = new int[]{19, 55, 38, 155, 255, 110, 137, 205, 76};
	static RSString aClass94_3998 = Class3_Sub4.createRSString(":trade:", (byte)-128);
	private static RSString aClass94_3999 = Class3_Sub4.createRSString("Apr", (byte)-128);
	private static RSString aClass94_4000 = Class3_Sub4.createRSString("Jun", (byte)-122);
	static int anInt4001;
	static int anInt4002 = 0;
	private static RSString aClass94_4003 = Class3_Sub4.createRSString("Sep", (byte)-126);
	private static RSString aClass94_4004 = Class3_Sub4.createRSString("Oct", (byte)-122);
	...
	final void method1868(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
		try {
			if(this.definition != null) {
				...
				Class140_Sub1 var15 = this.definition.method1476(this.aClass145Array2809, this.anInt2793, (byte)-116, this.anInt2813, this.anInt2776, this.anInt2760, this.anInt2832, var14, this.anInt2802, var13);
				if(var15 != null) {
	...
	final int getRenderAnimationId(int var1) {
		try {
			if(~Class158.anInt2014 != var1 && this.definition.anIntArray1292 != null) {
	...
	static final boolean method1986(int var0) {
		try {
			...
			return Class138.highDetail ?true:Class3_Sub28_Sub13.aBoolean3665;
		} catch (RuntimeException var2) {
