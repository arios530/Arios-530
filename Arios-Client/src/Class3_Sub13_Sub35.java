...
final class Class3_Sub13_Sub35 extends Class3_Sub13 {
   ...
   static RSString aClass94_3418 = Class3_Sub4.createRSString("(U5", (byte)-121);
   ...
   static final Class3_Sub28_Sub1 method336(int var0, byte var1) {
      try {
         ...
         if(null != var2) {
            ...
            byte[] var3;
            if(var0 < '\u8000') {
               var3 = Class47.aClass153_748.getFile(0, (byte)-122, var0);
            } else {
               var3 = NodeList.aClass153_332.getFile(0, (byte)-122, var0 & 32767);
            }
