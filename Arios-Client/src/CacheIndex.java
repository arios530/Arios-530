...
final class CacheIndex {
   ...
   final int method2120(RSString var1, byte var2) {
      try {
         if(this.method2122(3)) {
   ...
   final byte[] method2126(int var1, int[] xteaKeys, int var3, int var4) {
      try {
         if(!this.method2139(var1, 0, var4)) {
            return null;
         } else {
            if(this.anObjectArrayArray1952[var1] == null || this.anObjectArrayArray1952[var1][var4] == null) {
               boolean var5 = this.method2132(var1, false, xteaKeys);
               if(!var5) {
                  this.method2134(false, var1);
                  var5 = this.method2132(var1, false, xteaKeys);
                  if(!var5) {
                     return null;
                  }
               }
            ...
            if(var3 < 35) {
               ...
               byte[] var7 = NPC.method1985(-119, this.anObjectArrayArray1952[var1][var4], false);
         ...
         throw Class44.method1067(var6, "ve.BA(" + var1 + ',' + (xteaKeys != null?"{...}":"null") + ',' + var3 + ',' + var4 + ')');
      }
   }
   ...
   private final boolean method2132(int var1, boolean var2, int[] xteaKeys) {
      try {
         if(!this.method2130(var2, var1)) {
            ...
            if(var7) {
               ...
               byte[] var21;
               if(null != xteaKeys && (~xteaKeys[0] != -1 || -1 != ~xteaKeys[1] || 0 != xteaKeys[2] || xteaKeys[3] != 0)) {
               ...
               try {
                  ...
                  throw Class44.method1067(var19, "T3 - " + (xteaKeys != null) + "," + var1 + "," + var21.length + "," + Class38.method1026(var21, var21.length, false) + "," + Class38.method1026(var21, var21.length - 2, false) + "," + this.aClass62_1949.anIntArray945[var1] + "," + this.aClass62_1949.anInt964);
               }
         ...
         throw Class44.method1067(var20, "ve.I(" + var1 + ',' + var2 + ',' + (xteaKeys != null?"{...}":"null") + ')');
      }
   }

   final byte[] getFile(int var1, byte var2, int var3) {
      try {
         if(var2 != -122) {
   ...
   final byte[] method2140(int var1, int var2, int var3) {
      try {
         if(!this.method2139(var2, var3 + var3, var1)) {
            ...
            byte[] var6 = NPC.method1985(-126, this.anObjectArrayArray1952[var2][var1], false);
            return var6;
         }
      } catch (RuntimeException var5) {
