...
final class Class3_Sub13_Sub33 extends Class3_Sub13 {
   ...
   static RSString aClass94_3394 = Class3_Sub4.createRSString("<col=ffb000>", (byte)-123);
   static int anInt3395;
   static byte[] aByteArray3396;
   
   static volatile int anInt3398 = 0;
   static RSString aClass94_3399 = Class3_Sub4.createRSString("<br>(X", (byte)-119);
   private static RSString aClass94_3400 = Class3_Sub4.createRSString("Take", (byte)-126);
   static RSString aClass94_3401 = Class3_Sub4.createRSString("Weiter", (byte)-118);
