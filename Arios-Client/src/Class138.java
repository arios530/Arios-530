...
final class Class138 {
   ...
   private static com.jogamp.opengl.GLContext aGLContext1800;
   ...
   private static com.jogamp.opengl.GLDrawable aGLDrawable1815;
   private static boolean aBoolean1816 = true;
   static boolean aBoolean1817;
   static boolean aBoolean1818;
   private static RSString aClass94_1819 = Class3_Sub4.createRSString("radeon", (byte)-119);
   ...
   static final void method1834(Canvas var0) { //createAndDestroyContext
      ...
      try {
		 ...
		 AWTGraphicsConfiguration config = AWTGraphicsConfiguration.create(var0.getGraphicsConfiguration(), glCaps, glCaps);
         JAWTWindow jawtWindow = NewtFactoryAWT.getNativeWindow(var0, config);
         GLDrawableFactory var1 = GLDrawableFactory.getFactory(profile);
         GLDrawable var2 = var1.createGLDrawable(jawtWindow);
   ...
   static void glDpiAwareViewport(final int x, final int y, final int width, final int height) {
        AffineTransform t = ((Graphics2D) Class3_Sub28_Sub12.aCanvas3648.getGraphics()).getTransform();
    ...
    public static int getScaledValue(final double scale, final int value) {
      return scale(value, (float) scale);
    }

    public static int scale(int var0, float var1) {
        return (int) ((float) var0 * var1 + 0.5F);
    }
   ...
   private static final void method1836() {
      if(!aBoolean1799) {
         ...
         glDpiAwareViewport(0, 0, anInt1820, anInt1811);
         aGL1804.glMatrixMode(5888);
         aGL1804.glLoadIdentity();
         aBoolean1799 = true;
      }
   ...
   private static final int method1840() {
      ...
      if(var0 != 0) {
         ...
         if(aBoolean1813) {
            try {
               int[] var14 = new int[1];
               aGL1804.glGenBuffers(1, var14, 0);
   ...
   static final void method1842() {
      ...
      if(aGLContext1800 != null) {
         ...
         try {
            if(com.jogamp.opengl.GLContext.getCurrent() == aGLContext1800) {
   ...
   static final void method1844(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, int var8, int var9) {
      ...
      aGL1804.glMatrixMode(5889);
      aGL1804.glLoadIdentity();
      //cam-angle, cam-angle, cam-angle, cam-angle, zoom, FOG
      method1848((float) var10 * aFloat1801, (float) var11 * aFloat1801, (float) (-var13) * aFloat1801, (float) (-var12) * aFloat1801, 50.0F, Class40.render_distance * 128); //camera settings
      //viewport-offset-on-screen-horizontal, same-vertical, scrunch, scrunch
      //aGL1804.glViewport(var0, anInt1811 - var1 - var3, var2, var3);
      glDpiAwareViewport(var0, anInt1811 - var1 - var3, var2, var3);
      aGL1804.glMatrixMode(5888);
      aGL1804.glLoadIdentity();
...
// need to initialize a context to get the vendor name before the full context is made
   ...
   static final int method1853(Canvas var0, int var1) {
      try {
         if(!var0.isDisplayable()) {
            ...
            GLProfile profile = GLProfile.getDefault();
            com.jogamp.opengl.GLCapabilities var2 = new com.jogamp.opengl.GLCapabilities(profile);
            if(var1 > 0) {
               if (!(Class87.osName.startsWith("linux") && getVendorFirst(var0).startsWith("NVIDIA"))) {
            ...
            AWTGraphicsConfiguration config = AWTGraphicsConfiguration.create(var0.getGraphicsConfiguration(), var2, var2);
            JAWTWindow jawtWindow = NewtFactoryAWT.getNativeWindow(var0, config);
            com.jogamp.opengl.GLDrawableFactory var3 = com.jogamp.opengl.GLDrawableFactory.getFactory(profile);
            ...
            try
            {
                aGLDrawable1815 = var3.createGLDrawable(jawtWindow);
            ...
            int var5;
            while(true) {
               aGLContext1800 = aGLDrawable1815.createContext((com.jogamp.opengl.GLContext)null);
            ...
            aGL1804 = aGLContext1800.getGL().getGL2();
            new GLU();
            highDetail = true;
   ...
   static final void method1855(int var0, int var1, int var2, int var3, int var4, int var5) {
      ...
      aGL1804.glOrtho((double)((float)var6 * var11), (double)((float)var7 * var11), (double)((float)(-var9) * var12), (double)((float)(-var8) * var12), (double)(50 - var3), (double)((Class40.render_distance * 128) - var3));
      //Let's use the DPI aware viewport.
      //aGL1804.glViewport(0, 0, anInt1820, anInt1811);
      glDpiAwareViewport(0, 0, anInt1820, anInt1811);
      aGL1804.glMatrixMode(5888);
      aGL1804.glLoadIdentity();
