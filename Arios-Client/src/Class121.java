...
final class Class121 {
   ...
   static RSString aClass94_1645 = Class3_Sub4.createRSString("Hidden)2", (byte)-119);
   static RSString aClass94_1646 = Class3_Sub4.createRSString("::wm2", (byte)-118);
   static RSString aClass94_1647 = Class3_Sub4.createRSString("gleiten:", (byte)-117);
   int anInt1648 = 0;
      ...
      try {
         try {
            if(~Class43.anInt692 == -1) {
               ...
               Class3_Sub9.aClass64_2318 = Class38.aClass87_665.method1441((byte)8, RuntimeException_Sub1.worldListHost, ClientLoader.WLPORT);//, Class123.anInt1658);
               ...
               if(Class3_Sub20.wlPacketIndex >= Class66.wlPacketSize) {
                  if(Class3_Sub13_Sub23.handleWorldListUpdate(4, Class3_Sub13_Sub33.aByteArray3396)) {
                     ...
                     for(int var3 = Class3_Sub13_Sub4.worldListOffset; var3 <= Class100.worldListArraySize; ++var3) {
                        WorldListEntry var4 = Class3_Sub8.method130(91, var3);
                        if(null != var4) {
