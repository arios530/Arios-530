...
final class Class3_Sub1 extends Class3 {
   ...
   int anInt2202;
   static CacheIndex aClass153_2203;
   static int anInt2204;
   int anInt2205;
   private static RSString aClass94_2206 = Class3_Sub4.createRSString("white:", (byte)-117);
   static RSString aClass94_2207 = Class3_Sub4.createRSString("brillant2:", (byte)-118);
   ...
   final boolean method99(int var1) {
      try {
         if(var1 != 31595) {
            aClass153_2203 = (CacheIndex)null;
         }
