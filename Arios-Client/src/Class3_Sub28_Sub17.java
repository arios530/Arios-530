...
abstract class Class3_Sub28_Sub17 extends Node {
   ...
   private static RSString aClass94_3711 = Class3_Sub4.createRSString("gt", (byte)-121);
   private static RSString aClass94_3712 = Class3_Sub4.createRSString("lt", (byte)-120);
   private static RSString aClass94_3713 = Class3_Sub4.createRSString("shad=", (byte)-127);
   private static RSString aClass94_3714 = Class3_Sub4.createRSString("shy", (byte)-117);
   private static RSString aClass94_3715 = Class3_Sub4.createRSString("trans=", (byte)-123);
   private static RSString aClass94_3716 = Class3_Sub4.createRSString("u=", (byte)-119);
   private static RSString aClass94_3717 = Class3_Sub4.createRSString("str=", (byte)-128);
   private static RSString aClass94_3718 = Class3_Sub4.createRSString("euro", (byte)-125);
   private int[] anIntArray3719;
   private static RSString aClass94_3720 = Class3_Sub4.createRSString(")4col", (byte)-122);
   int[] anIntArray3721;
   private int anInt3722;
   private int[] anIntArray3723;
   private static RSString aClass94_3724 = Class3_Sub4.createRSString(")4shad", (byte)-123);
   private static RSString aClass94_3725 = Class3_Sub4.createRSString("col=", (byte)-122);
   private static RSString aClass94_3726 = Class3_Sub4.createRSString("<gt>", (byte)-128);
   int anInt3727 = 0;
   private static RSString aClass94_3728 = Class3_Sub4.createRSString("u", (byte)-118);
   private static RSString aClass94_3729 = Class3_Sub4.createRSString("times", (byte)-118);
   private int[] anIntArray3730;
   private static RSString aClass94_3731 = Class3_Sub4.createRSString(")4trans", (byte)-126);
   private static RSString aClass94_3732 = Class3_Sub4.createRSString("nbsp", (byte)-128);
   private byte[] aByteArray3733;
   private static RSString aClass94_3734 = Class3_Sub4.createRSString("<lt>", (byte)-124);
   private static RSString aClass94_3735 = Class3_Sub4.createRSString(")4u", (byte)-123);
   private int[] anIntArray3736;
   private static RSString aClass94_3737 = Class3_Sub4.createRSString("br", (byte)-120);
   private static RSString aClass94_3738 = Class3_Sub4.createRSString("shad", (byte)-124);
   private static RSString aClass94_3739 = Class3_Sub4.createRSString("img=", (byte)-123);
   private Class109[] aClass109Array3740;
   private static RSString aClass94_3741 = Class3_Sub4.createRSString("copy", (byte)-117);
   private static RSString aClass94_3742 = Class3_Sub4.createRSString(")4str", (byte)-125);
   private static RSString aClass94_3743 = Class3_Sub4.createRSString("reg", (byte)-117);
   private static RSString aClass94_3744 = Class3_Sub4.createRSString("str", (byte)-125);
