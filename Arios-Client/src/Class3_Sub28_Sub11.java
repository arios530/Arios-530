...
final class Class3_Sub28_Sub11 extends Node {
   ...
   static RSString aClass94_3637 = Class3_Sub4.createRSString(")4p=", (byte)-119);
   private static RSString aClass94_3638 = Class3_Sub4.createRSString("Loading fonts )2 ", (byte)-126);
   private static RSString aClass94_3639 = Class3_Sub4.createRSString(" is already on your friend list)3", (byte)-117);
         ...
         if(var3 < -2) {
            if(249 == var2) {
               ...
               for(var5 = 0; var4 > var5; ++var5) {
                  ...
                  Object var8;
                  if(!var6) {
                     var8 = new Class3_Sub18(var1.getInt(-502942936));
                  } else {
   ...
   static final void method603(int var0, int var1, int var2, RSInterface var3, boolean var4) {
      try {
         ...
         if(Class69.aBoolean1040 && (-1 != ~client.method44(var3).anInt2205 || ~var3.anInt187 == -1)) {
   ...
   static final void method607(boolean var0) {
      try {
         ...
         Applet_Sub1.aClass94_4 = ItemDefinition.aClass94_808;
         ...
         Node.aClass94_2576 = Class3_Sub17.aClass94_2461;
