...
abstract class Class3_Sub28_Sub16 extends Node {
   ...
   static RSString aClass94_3700 = Class3_Sub4.createRSString("::cardmem", (byte)-128);
   int anInt3701;
   static RSString aClass94_3702 = Class3_Sub4.createRSString(" )2> <col=ffff00>", (byte)-120);
   static RSString aClass94_3703 = Class3_Sub4.createRSString(" )2> ", (byte)-120);
   static int anInt3704;
   static RSString aClass94_3705 = Class3_Sub4.createRSString("W-=hlen Sie eine Option", (byte)-125);
   int anInt3706;
   int anInt3707;
