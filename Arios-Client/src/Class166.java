...
final class Class166 {
   ...
   static RSString aClass94_2074 = Class3_Sub4.createRSString("; version=1; path=)4; domain=", (byte)-117);
   static RSString aClass94_2075 = Class3_Sub4.createRSString("rect_debug=", (byte)-122);
   byte[] aByteArray2076;
   int anInt2077;
   int anInt2078;
   static int anInt2079 = 0;
   static RSString aClass94_2080 = Class3_Sub4.createRSString("(U2", (byte)-118);
   ...
   static final void method2258(int var0, int var1, RSString var2) {
      try {
         ...
         for(int var5 = var1; ~var5 > ~Class159.localPlayerCount; ++var5) {
            ...
            if(null != var6 && null != var6.displayName && var6.displayName.method1531(-110, var3)) {
               var4 = true;
         ...
         if(!var4) {
            Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, RenderAnimationDefinition.method903(new RSString[]{Class43.aClass94_691, var3}, (byte)-77), -1);
         }
   ...
   static final Class109 method2259(byte var0) {
      try {
         ...
         if(Class138.highDetail) {
            var1 = new Class109_Sub2(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[0], RSByteBuffer.anIntArray2591[0], Class140_Sub7.anIntArray2931[0], Class3_Sub13_Sub6.anIntArray3076[0], Class163_Sub1.aByteArrayArray2987[0], Class3_Sub13_Sub38.anIntArray3446);
         } else {
            var1 = new Class109_Sub1(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[0], RSByteBuffer.anIntArray2591[0], Class140_Sub7.anIntArray2931[0], Class3_Sub13_Sub6.anIntArray3076[0], Class163_Sub1.aByteArrayArray2987[0], Class3_Sub13_Sub38.anIntArray3446);
         }
