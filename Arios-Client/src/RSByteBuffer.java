...
class RSByteBuffer extends Class3 {
	...
	private static RSString aClass94_2593 = Class3_Sub4.createRSString("Loaded interfaces", (byte)-117);
	static RSString aClass94_2594 = Class3_Sub4.createRSString("Polices charg-Bes", (byte)-126);
	int index;
	static RSString[] aClass94Array2596 = null;
	static RSString aClass94_2597 = aClass94_2593;
	static RSString aClass94_2598 = Class3_Sub4.createRSString("<br>", (byte)-124);
	static RSString aClass94_2599 = Class3_Sub4.createRSString("d-Broulement:", (byte)-119);
	...
	final int getInt(int var1) {
		try {
			this.index += 4;
			return var1 != -502942936?104:((255 & this.buffer[this.index - 4]) << 24) + (16711680 & this.buffer[this.index + -3] << 16) + (((255 & this.buffer[this.index - 2]) << 8) - -(this.buffer[this.index - 1] & 255));
		} catch (RuntimeException var3) {
			throw Class44.method1067(var3, "wa.KA(" + var1 + ')');
		}
	}

	//getByte straight from Kratos/Crandor
	...
	//getInt straight from Kratos/Crandor
	...
	final long getLong(int var1) {
		try {
			if(var1 > -75) {
				...
				long var2 = (long)this.getInt(-502942936) & 4294967295L;
				long var4 = 4294967295L & (long)this.getInt(-502942936);
				return var4 + (var2 << 32);
			}
		} catch (RuntimeException var6) {
	...
	final byte getByte(boolean var1) {
		try {
			return var1?-13:this.buffer[this.index++];
		} catch (RuntimeException var3) {
	...
	final void method770(int[] var1, int var2, int var3, int var4) {
		try {
			...
			for(int var7 = 0; var6 > var7; ++var7) {
				int var10 = -957401312;
				int var8 = this.getInt(-502942936);
				int var9 = this.getInt(-502942936);
				int var12 = 32;
		...
		try {
			...
			for(var21 = false; var20.index < var20.buffer.length; var21 = true) {
				...
				for(var12 = 0; var12 < 4; ++var12) {
					byte var13 = var20.getByte(false);
					if(0 != var13) {
						if(1 != var13) {
							if(var13 == 2 && -1 > ~var12) {
								var15 = var5 + 64;
							...
							for(var14 = 0; ~var14 > -65; var14 += 4) {
								for(var15 = 0; var15 < 64; var15 += 4) {
									byte var16 = var20.getByte(false);
		...
		try {
			...
			if(~Class140_Sub3.anInt2737 <= -101) {
				...
				if(Class20.aBoolean438) {
					...
					Class126.aClass3_Sub28_Sub17_1669.method688(RenderAnimationDefinition.method903(new RSString[]{Class65.aClass94_985, Class72.method1298((byte)9, Class142.anInt1862)}, (byte)-62), var9, var10, 16776960, -1);
