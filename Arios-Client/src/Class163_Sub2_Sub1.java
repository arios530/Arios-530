...
final class Class163_Sub2_Sub1 extends Class163_Sub2 {
   ...
   private static RSString aClass94_4022 = Class3_Sub4.createRSString("Your friend list is full)3 Max of 100 for free users)1 and 200 for members)3", (byte)-120);
   static RSString aClass94_4023 = Class3_Sub4.createRSString(")3", (byte)-120);
   ...
   static final boolean method2224(byte var0, long var1, int var3, int var4) {
      try {
         ...
         if(var5 != 10 && -12 != ~var5 && var5 != 22) {
            ...
            ObjectDefinition var8 = Class162.method2207(4, var7);
            int var9;
            int var10;
            if(~var6 != -1 && ~var6 != -3) {
