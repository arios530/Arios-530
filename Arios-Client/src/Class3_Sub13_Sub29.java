...
final class Class3_Sub13_Sub29 extends Class3_Sub13 {
   ...
   static RSString aClass94_3357 = Class3_Sub4.createRSString("", (byte)-119);
   static boolean disableGEBoxes = false;
   static int[] anIntArray3359 = new int[5];
   static RSString aClass94_3360 = Class3_Sub4.createRSString("mem=", (byte)-127);
   ...
   static final void method304(int var0) {
      try {
         if(var0 != 6799) {
            method305((Class87)null, (RSByteBuffer)null, -13, (byte)41);
         }
   ...
   static final void method305(Class87 var0, RSByteBuffer var1, int var2, byte var3) {
      try {
         int var5 = 123 % ((var3 - -66) / 57);
         Class3_Sub8 var4 = new Class3_Sub8();
         var4.anInt2296 = var1.getByte((byte)-54);
         var4.anInt2305 = var1.getInt(-502942936);
