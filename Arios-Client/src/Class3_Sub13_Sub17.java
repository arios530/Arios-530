...
final class Class3_Sub13_Sub17 extends Class3_Sub13 {
   ...
   static RSString aClass94_3209 = Class3_Sub4.createRSString("showingVideoAd", (byte)-117);
   static CacheIndex aClass153_3210;
   static RSString aClass94_3211 = Class3_Sub4.createRSString(" <col=ffffff>", (byte)-126);
   ...
   static final void method252(int var0) {
      try {
         ...
         for(var1 = (Class3_Sub9)IOHandler.aClass61_1242.method1222(-110); null != var1; var1 = (Class3_Sub9)IOHandler.aClass61_1242.method1221(4)) {
            if(var1.aBoolean2329) {
               var1.method134(1);
            }
         }
