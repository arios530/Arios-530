...
final class Class3_Sub28_Sub4 extends Node {
   ...
   static RSString aClass94_3573 = Class3_Sub4.createRSString(" )2> <col=00ffff>", (byte)-124);
   static RSString aClass94_3574 = Class3_Sub4.createRSString("titlebg", (byte)-118);
  
   static RSString aClass94_3576 = Class3_Sub4.createRSString("name_icons", (byte)-126);
   static RSString aClass94_3577 = Class3_Sub4.createRSString(": ", (byte)-120);
   private static RSString aClass94_3578 = Class3_Sub4.createRSString("Loaded title screen", (byte)-126);
