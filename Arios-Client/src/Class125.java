...
final class Class125 implements Interface5 {
   ...
   public final void method22() {
      if(this.anInt2186 >= 0) {
         ...
         if(!Class88.aBoolean1227) {
            var1.glBindTexture(3553, Class88.anIntArray1224[(int)((float)(Class138.anInt1791 * 64) * 0.0050F) % 64]);
         }

         var1.glActiveTexture('\u84c0');
         if(this.anInt2182 != Class138.anInt1791) {
            int var2 = (Class138.anInt1791 & 255) * 256;
            ...
            if(Class88.aBoolean1227) {
               var1.glProgramLocalParameter4fARB('\u8620', 65, (float)Class138.anInt1791 * 0.0050F, 0.0F, 0.0F, 1.0F);
            } else {
               var1.glProgramLocalParameter4fARB('\u8620', 65, 0.0F, 0.0F, 0.0F, 1.0F);
            }

            this.anInt2182 = Class138.anInt1791;
         }
   ...
   public Class125() {
      if(this.anInt2186 < 0) {
         if(Class138.aBoolean1818 && Class138.anInt1789 >= 2) {
            int[] var1 = new int[1];
            GL2 var2 = Class138.aGL1804;
