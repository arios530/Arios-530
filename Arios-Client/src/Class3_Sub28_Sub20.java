...
final class Class3_Sub28_Sub20 extends Node {
   ...
   static RSString aClass94_3785 = Class3_Sub4.createRSString("Benutzeroberfl-=che geladen)3", (byte)-125);
   ...
   static RSString aClass94_3792 = Class3_Sub4.createRSString("huffman", (byte)-120);
   ...
   static RSString aClass94_3798 = Class3_Sub4.createRSString("RuneScape wird geladen )2 bitte warten)3)3)3", (byte)-121);
            ...
            if(~(1 & var7) == -1) {
               if(0 != ~this.anInt3795) {
                  ...
                  if(2 != this.anInt3788) {
                     ...
                     int num_mipmaps = 4;
					 var5.glTexStorage2D(GL2.GL_TEXTURE_2D, num_mipmaps, GL2.GL_RGBA8, var6, var6);
					 var5.glTexSubImage2D(GL2.GL_TEXTURE_2D, 0, 0, 0, var6, var6, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, var9);
					 var5.glGenerateMipmap(GL2.GL_TEXTURE_2D);
					 var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_WRAP_S, GL2.GL_REPEAT);
					 var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_WRAP_T, GL2.GL_REPEAT);
					 var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MAG_FILTER, GL2.GL_LINEAR);
					 var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MIN_FILTER, GL2.GL_LINEAR_MIPMAP_LINEAR);
         ...
         if(~Class137.method1817((byte)70) == -3) {
            ...
            if(WorldListCountry.localPlane != 3) {
               ...
               if(1 == Class133.anInt1753) {
                  if((4 & Class9.aByteArrayArrayArray113[WorldListCountry.localPlane][Class102.aClass140_Sub4_Sub1_2141.anInt2819 >> 7][Class102.aClass140_Sub4_Sub1_2141.anInt2829 >> 7]) != 0) {
   ...
   Class3_Sub28_Sub20(RSByteBuffer var1) {
      try {
         ...
         this.anInt3783 = var1.getByte(false);
         this.anInt3799 = var1.getByte(false);
