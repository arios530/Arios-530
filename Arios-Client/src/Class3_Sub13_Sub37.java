...
final class Class3_Sub13_Sub37 extends Class3_Sub13 {
      ...
      try {
         ...
         if(~var5 < -1) {
            for(int var6 = 0; var6 < 257; ++var6) {
               ...
               this.anIntArray3443[var6] = Class3_Sub13_Sub29.method308(var4, Class3_Sub13_Sub29.method308(var3 << 8, var2 << 16));
            }
         }
   ...
   static final void method347(boolean var0) {
      try {
         ...
         int var1 = Class131.anInt1716 + (Class102.aClass140_Sub4_Sub1_2141.anInt2819 >> 7);
         int var2 = (Class102.aClass140_Sub4_Sub1_2141.anInt2829 >> 7) - -Class82.anInt1152;
