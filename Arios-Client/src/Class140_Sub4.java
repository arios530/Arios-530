...
abstract class Class140_Sub4 extends Class140 {
   ...
   int anInt2764 = -1;
   static RSString aClass94_2765 = Class3_Sub4.createRSString(" ", (byte)-120);
   ...
   final void method1967(int var1, int var2, int var3, int var4, boolean var5) {
      try {
         if(~this.anInt2771 != 0 && -2 == ~client.method45(this.anInt2771, (byte)-20).anInt1850) {
            this.anInt2771 = -1;
         }
         ...
         if(Class138.highDetail && Class102.aClass140_Sub4_Sub1_2141 == this) {
   ...
   final void walkStep(int var1, byte var2, int var3) {
      try {
         ...
         if(~this.anInt2771 != 0 && 1 == client.method45(this.anInt2771, (byte)-20).anInt1850) {
            this.anInt2771 = -1;
         }
