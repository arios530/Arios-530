...
final class Class54 {
   ...
   static int anInt869;
   int[] anIntArray870;
   static RSString aClass94_871 = Class3_Sub4.createRSString("hint_headicons", (byte)-121);
   static int anInt872;
   RSString[] aClass94Array873;
   Class3_Sub28_Sub15 aClass3_Sub28_Sub15_874;
   static RSString aClass94_875 = Class3_Sub4.createRSString("Benutzen", (byte)-117);
   static int anInt876;
   int anInt877 = -1;
   ...
   static final boolean method1176(RSString var0, byte var1) {
      try {
         if(var0 != null) {
            ...
            if(var0.method1531(var1 + -46, Class102.aClass140_Sub4_Sub1_2141.displayName)) {
               return true;
            } else {
               return false;
            }
