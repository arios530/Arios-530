...
final class Class45 {
   ...
   static RSString aClass94_728 = Class3_Sub4.createRSString("leuchten2:", (byte)-117);
   ...
   static final void parsePlayerMask(int var0, int var1, byte var2, Player var3) {
      try {
         ...
         if(0 != (var0 & 128)) {
            ...
            var5 = GraphicDefinition.incomingBuffer.getByte((byte)-54);
            ...
            if(null != var3.displayName && var3.aClass52_3962 != null) {
               ...
               if(!var11 && 0 == WorldListEntry.anInt2622) {
                  ...
                  if(-3 != ~var5) {
                     if(~var5 != -2) {
                        ...
                        Class3_Sub28_Sub12.method611(var13, var8?17:1, var25, (RSString)null, (byte)50, RenderAnimationDefinition.method903(new RSString[]{Class32.aClass94_592, var3.method1980(0)}, (byte)-127));
                     }
                  } else {
                     Class3_Sub28_Sub12.method611(var13, !var8?1:17, var25, (RSString)null, (byte)50, RenderAnimationDefinition.method903(new RSString[]{Class21.aClass94_444, var3.method1980(var2 + 79)}, (byte)-116));
                  }
               }
            }
         ...
         if(~(var0 & 1) != -1) {
            ...
            var5 = GraphicDefinition.incomingBuffer.getByteA((byte)-99);
         ...
         if((var0 & 8) != 0) {
            ...
            var5 = GraphicDefinition.incomingBuffer.getByte((byte)-112);
         ...
         if(~(var0 & 32) != -1) {
            var3.aClass94_2825 = GraphicDefinition.incomingBuffer.getString();
            if(~var3.aClass94_2825.charAt(0, (byte)-45) == -127) {
         ...
         if(~(var0 & 512) != -1) {
            var4 = GraphicDefinition.incomingBuffer.getSmart(true);
            var5 = GraphicDefinition.incomingBuffer.getByteS(true);
         ...
         if((256 & var0) != 0) {
            ...
            var5 = GraphicDefinition.incomingBuffer.getIntB((byte)-73);
            boolean var21 = true;
            if(~var4 != 0 && 0 != ~var3.anInt2842 && client.method45(RenderAnimationDefinition.getGraphicDefinition((byte)42, var4).anInt542, (byte)-20).anInt1857 < client.method45(RenderAnimationDefinition.getGraphicDefinition((byte)42, var3.anInt2842).anInt542, (byte)-20).anInt1857) {
               var21 = false;
            }
               ...
               if(~var3.anInt2842 != 0 && Class44.anInt719 == var3.anInt2759) {
                  ...
                  if(0 != ~var7) {
                     ...
                     if(null != var24 && var24.anIntArray1851 != null) {
                        IOHandler.method1470(var3.anInt2829, var24, 183921384, var3.anInt2819, var3 == Class102.aClass140_Sub4_Sub1_2141, 0);
                     }
                  }
               }
            }
   ...
   static final void method1082(byte[] var0, int var1) {
      try {
         ...
         for(var4 = 1; ~var4 > ~var3; ++var4) {
            Class3_Sub13_Sub38.anIntArray3446[var4] = var2.getTriByte((byte)122);
            ...
            if(-1 != ~(1 & var11)) {
               ...
               for(var12 = 0; ~var12 > ~var5; ++var12) {
                  for(var13 = 0; var13 < var6; ++var13) {
                     var8[var12 + var13 * var5] = var2.getByte(false);
                  }
               }
               ...
               if(-1 != ~(var11 & 2)) {
                  for(var12 = 0; ~var12 > ~var5; ++var12) {
                     for(var13 = 0; var13 < var6; ++var13) {
                        byte var14 = var9[var5 * var13 + var12] = var2.getByte(false);
                        var10 |= -1 != var14;
                     }
                  }
               }
               ...
               for(var12 = 0; ~var7 < ~var12; ++var12) {
                  var8[var12] = var2.getByte(false);
               }

               if((2 & var11) != 0) {
                  for(var12 = 0; ~var12 > ~var7; ++var12) {
                     byte var16 = var9[var12] = var2.getByte(false);
                     var10 |= var16 != -1;
                  }
               }
            }
