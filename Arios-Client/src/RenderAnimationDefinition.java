...
final class RenderAnimationDefinition {
   ...
   private static RSString aClass94_354 = Class3_Sub4.createRSString("Discard", (byte)-118);
   static RSString aClass94_355 = Class3_Sub4.createRSString("Lade Konfiguration )2 ", (byte)-125);
   ...
   private static RSString aClass94_363 = Class3_Sub4.createRSString("Aug", (byte)-121);
   int anInt364 = -1;
   private static RSString aClass94_365 = Class3_Sub4.createRSString("May", (byte)-125);
   private static RSString aClass94_366 = Class3_Sub4.createRSString("Loaded world list data", (byte)-122);
   int anInt367 = -1;
   int anInt368 = -1;
   int anInt369 = 0;
   int anInt370 = 0;
   ...
   int anInt375 = -1;
   private static RSString aClass94_376 = Class3_Sub4.createRSString("Jul", (byte)-117);
   ...
   private static RSString aClass94_385 = Class3_Sub4.createRSString("Jun", (byte)-127);
   int anInt386 = -1;
   int anInt387 = 0;
   private static RSString aClass94_388 = Class3_Sub4.createRSString("Dec", (byte)-119);
   int anInt389 = -1;
   int anInt390 = -1;
   private static RSString aClass94_391 = Class3_Sub4.createRSString("Oct", (byte)-121);
   private static RSString aClass94_392 = Class3_Sub4.createRSString("Jan", (byte)-127);
   int anInt393 = -1;
   private static RSString aClass94_394 = Class3_Sub4.createRSString("Sep", (byte)-118);
   int anInt395 = 0;
   static int anInt396;
   private static RSString aClass94_397 = Class3_Sub4.createRSString("Nov", (byte)-126);
   int anInt398 = -1;
   int anInt399 = 0;
   int anInt400 = 0;
   private static RSString aClass94_401 = Class3_Sub4.createRSString("Apr", (byte)-120);
   static boolean aBoolean402 = false;
   int anInt403 = 0;
   private static RSString aClass94_404 = Class3_Sub4.createRSString("Mar", (byte)-118);
   private static RSString aClass94_405 = Class3_Sub4.createRSString("Feb", (byte)-117);
   int anInt406 = -1;
   int anInt407 = -1;
   ...
   static final void method900(Class140_Sub4 var0, int var1) {
      try {
         ...
         Class142 var2;
         if(-1 != var0.anInt2764) {
            var2 = client.method45(var0.anInt2764, (byte)-20);
            if(null != var2 && null != var2.anIntArray1851) {
               ...
               if(~var2.anIntArray1851.length < ~var0.anInt2813 && var0.anInt2802 > var2.anIntArray1869[var0.anInt2813]) {
                  ...
                  ++var0.anInt2813;
                  ++var0.anInt2793;
                  IOHandler.method1470(var0.anInt2829, var2, 183921384, var0.anInt2819, var0 == Class102.aClass140_Sub4_Sub1_2141, var0.anInt2813);
               }

               if(~var0.anInt2813 <= ~var2.anIntArray1851.length) {
                  var0.anInt2813 = 0;
                  var0.anInt2802 = 0;
                  IOHandler.method1470(var0.anInt2829, var2, 183921384, var0.anInt2819, Class102.aClass140_Sub4_Sub1_2141 == var0, var0.anInt2813);
               }
         ...
         if(~var0.anInt2842 != 0 && ~Class44.anInt719 <= ~var0.anInt2759) {
            ...
            if(0 != ~var6) {
               Class142 var3 = client.method45(var6, (byte)-20);
               if(var3 != null && var3.anIntArray1851 != null) {
                  if(0 > var0.anInt2805) {
                     var0.anInt2805 = 0;
                     IOHandler.method1470(var0.anInt2829, var3, 183921384, var0.anInt2819, Class102.aClass140_Sub4_Sub1_2141 == var0, 0);
                  }
                  ...
                  if(var0.anInt2805 < var3.anIntArray1851.length && ~var3.anIntArray1869[var0.anInt2805] > ~var0.anInt2761) {
                     ++var0.anInt2805;
                     var0.anInt2761 = 1;
                     IOHandler.method1470(var0.anInt2829, var3, var1 ^ -183911469, var0.anInt2819, Class102.aClass140_Sub4_Sub1_2141 == var0, var0.anInt2805);
                  }
         ...
         if(~var0.anInt2771 != 0 && -2 <= ~var0.anInt2828) {
            var2 = client.method45(var0.anInt2771, (byte)-20);
         ...
         if(var1 == -11973) {
            if(~var0.anInt2771 != 0 && -1 == ~var0.anInt2828) {
               ...
               if(var2 != null && var2.anIntArray1851 != null) {
                  ...
                  if(~var0.anInt2832 > ~var2.anIntArray1851.length && var0.anInt2760 > var2.anIntArray1869[var0.anInt2832]) {
                     var0.anInt2760 = 1;
                     ++var0.anInt2832;
                     IOHandler.method1470(var0.anInt2829, var2, 183921384, var0.anInt2819, var0 == Class102.aClass140_Sub4_Sub1_2141, var0.anInt2832);
                  }
                  ...
                  if(var2.anIntArray1851.length <= var0.anInt2832) {
                     ...
                     if(~var0.anInt2773 > ~var2.anInt1861) {
                        if(var0.anInt2832 >= 0 && ~var2.anIntArray1851.length < ~var0.anInt2832) {
                           IOHandler.method1470(var0.anInt2829, var2, var1 ^ -183911469, var0.anInt2819, Class102.aClass140_Sub4_Sub1_2141 == var0, var0.anInt2832);
                        } else {
                           var0.anInt2771 = -1;
                        }
                     } else {
            ...
            for(var6 = 0; var0.aClass145Array2809.length > var6; ++var6) {
               ...
               if(null != var7) {
                  if(~var7.anInt1900 >= -1) {
                     Class142 var4 = client.method45(var7.anInt1890, (byte)-20);
                     if(null != var4 && var4.anIntArray1851 != null) {
                        ...
                        if(var7.anInt1893 < var4.anIntArray1851.length && var7.anInt1897 > var4.anIntArray1869[var7.anInt1893]) {
                           ++var7.anInt1893;
                           var7.anInt1897 = 1;
                           IOHandler.method1470(var0.anInt2829, var4, 183921384, var0.anInt2819, var0 == Class102.aClass140_Sub4_Sub1_2141, var7.anInt1893);
                        }
                        ...
                        if(~var4.anIntArray1851.length >= ~var7.anInt1893) {
                           ...
                           if(var4.anInt1861 > var7.anInt1894) {
                              if(-1 >= ~var7.anInt1893 && ~var7.anInt1893 > ~var4.anIntArray1851.length) {
                                 IOHandler.method1470(var0.anInt2829, var4, 183921384, var0.anInt2819, Class102.aClass140_Sub4_Sub1_2141 == var0, var7.anInt1893);
                              } else {
