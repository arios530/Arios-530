...
final class NPCDefinition {
   ...
   static RSString aClass94_1281 = Class3_Sub4.createRSString("violet:", (byte)-126);
   ...
   int[] anIntArray1292;
   int anInt1293;
   static RSString aClass94_1294 = Class3_Sub4.createRSString("Votre liste noire est pleine (X100 noms maximum(Y)3", (byte)-118);
   ...
   final NPCDefinition method1471(byte var1) {
      try {
         ...
         if(0 <= var2 && ~var2 > ~(-1 + this.anIntArray1292.length) && this.anIntArray1292[var2] != -1) {
            var3 = -24 % ((-46 - var1) / 41);
            return Node.method522(this.anIntArray1292[var2], 27112);
         } else {
         ...
         if(this.anIntArray1292 != null) {
            for(int var2 = 0; ~this.anIntArray1292.length < ~var2; ++var2) {
               if(0 != ~this.anIntArray1292[var2]) {
                  NPCDefinition var3 = Node.method522(this.anIntArray1292[var2], 27112);
   ...
   final Class140_Sub1 method1476(Class145[] var1, int var2, byte var3, int var4, int var5, int var6, int var7, Class142 var8, int var9, Class142 var10) {
      try {
         if(this.anIntArray1292 != null) {
            ...
            Class140_Sub1 var11 = (Class140_Sub1)CS2Script.aClass93_2442.get((long)this.anInt1284, (byte)121);
            boolean var12;
            int var17;
            int var16;
            int var19;
            ...
            if(null == var11) {
               ...
               RenderAnimationDefinition var38 = null;
               if(-1 != this.renderAnimationId) {
                  var38 = Class3_Sub10.getRenderAnimationDefinition(false, this.renderAnimationId);
               }
               ...
               CS2Script.aClass93_2442.put((byte)-90, var11, (long)this.anInt1284);
            }
      ...
      try {
         if(this.anIntArray1292 == null) {
            if(null == this.anIntArray1250) {
               ...
               Class140_Sub1 var12 = (Class140_Sub1)Class154.aClass93_1964.get((long)this.anInt1284, (byte)121);
               if(var12 == null) {
                  boolean var7 = false;
                  ...
                  Class154.aClass93_1964.put((byte)-119, var12, (long)this.anInt1284);
               }
      ...
      try {
         ...
         if(1 == opcode) {
            ...
            for(var5 = 0; var4 > var5; ++var5) {
               this.anIntArray1288[var5] = buffer.getShort(1);
            ...
            if(~opcode != -13) {
               if(opcode >= 30 && ~opcode > -36) {
                  ...
                  if(this.options[-30 + opcode].method1531(-122, Class3_Sub13_Sub3.aClass94_3051)) {
                  ...
                  if(-42 != ~opcode) {
                     if(-43 == ~opcode) {
                        ...
                        for(var5 = 0; var4 > var5; ++var5) {
                           this.aByteArray1247[var5] = buffer.getByte(false);
                        }
                     } else if(~opcode == -61) {
                        ...
                        if(~opcode != -96) {
                           if(opcode != 97) {
                              if(-99 == ~opcode) {
                                 ...
                                 if(opcode != 100) {
                                    if(-102 == ~opcode) {
                                       this.anInt1282 = buffer.getByte(false) * 5;
                                    } else if(~opcode == -103) {
                                       ...
                                       if(106 != opcode && ~opcode != -119) {
                                          if(-108 == ~opcode) {
                                             ...
                                             if(opcode == 111) {
                                                ...
                                                this.aByte1287 = buffer.getByte(false);
                                                this.aByte1275 = buffer.getByte(false);
                                             } else if(~opcode != -116) {
                                                if(119 == opcode) {
                                                   this.aByte1267 = buffer.getByte(false);
                                                } else if(121 == opcode) {
                                                   ...
                                                   for(var5 = 0; var5 < var4; ++var5) {
                                                      ...
                                                      var7[0] = buffer.getByte(false);
                                                      var7[1] = buffer.getByte(false);
                                                      var7[2] = buffer.getByte(false);
                                                   }
                                                } else if(122 == opcode) {
                                                         ...
                                                         if(~opcode == -136) {
                                                            ...
                                                            if(~opcode == -250) {
                                                               ...
                                                               for(var5 = 0; ~var5 > ~var4; ++var5) {
                                                                  ...
                                                                  Object var8;
                                                                  if(!var11) {
                                                                     var8 = new Class3_Sub18(buffer.getInt(-502942936));
                                                                  } else {
                                                   ...
                                                   this.aByte1268 = buffer.getByte(false);
                                                }
                                             } else {
                                          ...
                                          this.anInt1257 = buffer.getShort(1);
                                          var4 = -1;
                                          if(-65536 == ~this.anInt1257) {
                                             this.anInt1257 = -1;
                                          }

                                          this.anInt1295 = buffer.getShort(1);
                                          ...
                                          for(var6 = 0; ~var5 <= ~var6; ++var6) {
                                             this.anIntArray1292[var6] = buffer.getShort(1);
                                    ...
                                    this.anInt1251 = buffer.getByte(false);
                                 }
                              } else {
