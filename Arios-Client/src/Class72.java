...
final class Class72 {
   ...
   static RSString aClass94_1070 = Class3_Sub4.createRSString("headicons_pk", (byte)-120);
   static int anInt1071 = 0;
   static RSString aClass94_1072 = Class3_Sub4.createRSString(" (X", (byte)-125);
   Class140 aClass140_1073;
   static boolean aBoolean1074 = false;
   int anInt1075;
   static RSString aClass94_1076 = Class3_Sub4.createRSString("<)4col>", (byte)-118);
   int anInt1077;
   int anInt1078;
   long aLong1079;
