...
final class Class52 {
   ...
   static RSString aClass94_852 = Class3_Sub4.createRSString("(U4", (byte)-120);
   static RSString aClass94_853 = Class3_Sub4.createRSString("::tele ", (byte)-120);
   int pnpcId;
   private long aLong855;
   static RSString aClass94_856 = Class3_Sub4.createRSString("::wm0", (byte)-120);
   ...
   final Class140_Sub1 method1157(int var1, int var2, int var3, int var4, Class142 var5, int var6, int var7, int var8) {
      try {
         ...
         Class140_Sub1 var11 = (Class140_Sub1)Class80.aClass93_1131.get(var9, (byte)121);
         if(null == var11) {
   ...
   final int method1163(int var1) {
      try {
         ...
         return this.pnpcId != -1?305419896 + Node.method522(this.pnpcId, var1 + '\ucb05').anInt1284:(this.anIntArray857[8] << 10) + ((this.anIntArray862[0] << 25) - -(this.anIntArray862[4] << 20)) - (-(this.anIntArray857[0] << 15) - ((this.anIntArray857[11] << 5) + this.anIntArray857[1]));
      } catch (RuntimeException var3) {
   ...
   final Class140_Sub1 method1165(Class145[] var1, int var2, Class142 var3, Class142 var4, int var5, int var6, int var7, int var8, boolean var9, int var10, int var11) {
      try {
         ...
         if(0 != ~this.pnpcId) {
            ...
            Class140_Sub1 var37 = (Class140_Sub1)Class148.aClass93_1911.get(var13, (byte)121);
            boolean var17;
            int var23;
            int var22;
            int var25;
            ...
            if(var37 == null) {
               ...
               if(var17) {
                  if(this.aLong855 != -1L) {
                     var37 = (Class140_Sub1)Class148.aClass93_1911.get(this.aLong855, (byte)121);
                  }
               ...
               if(null == var37) {
                  ...
                  if(this.anInt858 != -1) {
                     var40 = Class3_Sub10.getRenderAnimationDefinition(false, this.anInt858);
                  }
            ...
            for(var22 = 0; ~var45 < ~var22; ++var22) {
               if(var1[var22] != null) {
                  Class142 var41 = client.method45(var1[var22].anInt1890, (byte)-20);
   ...
   final Class140_Sub1 method1167(int var1, byte var2, Class142 var3, int var4, int var5) {
      try {
         if(0 == ~this.pnpcId) {
            Class140_Sub1 var6 = (Class140_Sub1)Class80.aClass93_1131.get(this.aLong860, (byte)121);
            if(var2 < 122) {
               this.anIntArray862 = (int[])null;
            }
            ...
            return Node.method522(this.pnpcId, 27112).method1482(var3, var1, var5, -109, var4);
         }
