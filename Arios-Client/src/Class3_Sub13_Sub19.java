...
final class Class3_Sub13_Sub19 extends Class3_Sub13 {
   ...
   private static RSString aClass94_3232 = Class3_Sub4.createRSString("pt", (byte)-120);
   private int anInt3233 = 8;
   private int anInt3234 = 1024;
   private int anInt3235;
   private int anInt3236 = 409;
   private static RSString aClass94_3237 = Class3_Sub4.createRSString("en", (byte)-127);
   private static RSString aClass94_3239 = Class3_Sub4.createRSString("fr", (byte)-124);
   private int[][] anIntArrayArray3240;
   static short aShort3241 = 1;
   private int anInt3242 = 4;
   private static RSString aClass94_3243 = Class3_Sub4.createRSString("de", (byte)-126);
