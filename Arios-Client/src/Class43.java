...
final class Class43 {
   ...
   private static RSString aClass94_695 = Class3_Sub4.createRSString("Unable to find ", (byte)-127);
   boolean aBoolean696 = false;
   int anInt697;
   int anInt698;
   static RSString aClass94_699 = Class3_Sub4.createRSString("clignotant3:", (byte)-119);
   static RSString aClass94_700 = Class3_Sub4.createRSString("blaugr-Un:", (byte)-120);
   static RSString aClass94_701 = Class3_Sub4.createRSString("Chargement de la liste des serveurs", (byte)-127);
