...
final class Class142 {
   ...
   static RSString aClass94_1863 = Class3_Sub4.createRSString(" steht bereits auf Ihrer Freunde)2Liste(Q", (byte)-124);
   int anInt1864;
   int anInt1865 = -1;
   int anInt1866 = -1;
   ...
   final Class140_Sub1 method2054(int var1, int var2, int var3, Class140_Sub1 var4, int var5, int var6) {
      try {
         ...
         if(var8 == null) {
            ...
            if(Class138.highDetail && this.aBoolean1848) {
               if(-2 != ~var5) {
                  if(2 != var5) {
                     if(~var5 == -4) {
   ...
   final Class140_Sub1 method2056(int var1, int var2, int var3, int var4, Class140_Sub1 var5, int var6) {
      try {
         ...
         if(null == var8) {
            ...
            if(this.aBoolean1848 && Class138.highDetail) {
               if(1 != var4) {
                  if(-3 == ~var4) {
                     ((Class140_Sub1_Sub1)var10).method1911();
                  } else if(-4 == ~var4) {
      ...
      try {
         ...
         if(~var1 == -2) {
            ...
            for(var5 = 0; var4 > var5; ++var5) {
               this.anIntArray1869[var5] = var3.getShort(1);
            }

            this.anIntArray1851 = new int[var4];

            for(var5 = 0; ~var5 > ~var4; ++var5) {
               this.anIntArray1851[var5] = var3.getShort(1);
            }

            for(var5 = 0; var4 > var5; ++var5) {
               this.anIntArray1851[var5] += var3.getShort(1) << 16;
            }
         } else if(var1 == 2) {
   ...
   static final void method2061(boolean var0) {
      try {
         ...
         Class45.anInt733 = 0;
         GraphicDefinition.anInt531 = 2047 & (int)(Math.random() * 20.0D) - 10;
         Class58.anInt909 = -1;
         ...
         Class102.aClass140_Sub4_Sub1_2141 = Class3_Sub13_Sub22.players[2047] = new Player();
