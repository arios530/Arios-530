...
final class Class157 {
   ...
   private static RSString aClass94_1998 = Class3_Sub4.createRSString("Connecting to update server", (byte)-118);
   private int[][] anIntArrayArray1999;
   static Class3_Sub28_Sub17_Sub1 aClass3_Sub28_Sub17_Sub1_2000;
   private int anInt2001;
   static RSString aClass94_2002 = Class3_Sub4.createRSString("Chargement des fichiers config )2 ", (byte)-117);
   static RSString aClass94_2003 = Class3_Sub4.createRSString("_labels", (byte)-121);
