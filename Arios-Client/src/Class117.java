...
final class Class117 {
   ...
   private static RSString aClass94_1610 = Class3_Sub4.createRSString("Loaded wordpack", (byte)-122);
   ...
   static RSString aClass94_1612 = Class3_Sub4.createRSString("classement ", (byte)-120);
   static int[] anIntArray1613 = new int[500];
   static RSString aClass94_1614 = Class3_Sub4.createRSString(":tradereq:", (byte)-128);
   ...
   static final void method1719(int var0, int var1) {
      try {
         if(Class143.anInt1875 != var0) {
            ...
            if(Class138.highDetail && (25 == var0 || var0 == 28 || -41 == ~var0)) {
               Class138.method1833();
            }
