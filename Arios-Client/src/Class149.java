...
final class Class149 implements MouseListener, MouseMotionListener, FocusListener {
   ...
   static RSString aClass94_1922 = Class3_Sub4.createRSString("weiss:", (byte)-118);
   ...
   public final synchronized void mouseDragged(MouseEvent var1) {
      try {
         ...
         int y = var1.getY();
         if (SwingUtilities.isMiddleMouseButton(var1)) {
             int accelX = mouseWheelX - x;
             int accelY = mouseWheelY - y;
             mouseWheelX = var1.getX();
             mouseWheelY = var1.getY();
             GraphicDefinition.anInt531 += accelX * 2;
