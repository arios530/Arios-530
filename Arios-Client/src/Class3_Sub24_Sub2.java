...
final class Class3_Sub24_Sub2 extends Class3_Sub24 {
   ...
   final synchronized void method413(int[] var1, int var2, int var3) {
      do {
         ...
         this.anInt3487 += var4;
         this.method458();
         Class3_Sub3 var5 = (Class3_Sub3)this.aClass61_3486.method1222(-49);
         synchronized(var5) {
   ...
   private final void method458() {
      if(this.anInt3487 > 0) {
         for(Class3_Sub3 var1 = (Class3_Sub3)this.aClass61_3486.method1222(-124); var1 != null; var1 = (Class3_Sub3)this.aClass61_3486.method1221(4)) {
   ...
   final Class3_Sub24 method411() {
      return (Class3_Sub24)this.aClass61_3485.method1222(-89);
   }

   private final void method459(int var1) {
      for(Class3_Sub24 var2 = (Class3_Sub24)this.aClass61_3485.method1222(-94); var2 != null; var2 = (Class3_Sub24)this.aClass61_3485.method1221(4)) {
         var2.method415(var1);
      }
   ...
   private final void method460(int[] var1, int var2, int var3) {
      for(Class3_Sub24 var4 = (Class3_Sub24)this.aClass61_3485.method1222(-113); var4 != null; var4 = (Class3_Sub24)this.aClass61_3485.method1221(4)) {
   ...
   final synchronized void method415(int var1) {
      do {
         ...
         this.anInt3487 += var2;
         this.method458();
         Class3_Sub3 var3 = (Class3_Sub3)this.aClass61_3486.method1222(-20);
         synchronized(var3) {
   ...
   final Class3_Sub24 method414() {
      return (Class3_Sub24)this.aClass61_3485.method1221(4);
   }
   ...
   private final void method462(Class3 var1, Class3_Sub3 var2) {
      ...
      Class109.method1662(var2, var1, -16);
