...
final class Class7 implements Interface4 {
   ...
   static RSString aClass94_2163 = Class3_Sub4.createRSString("Gegenstand f-Ur Mitglieder", (byte)-128);
   static RSString aClass94_2164 = Class3_Sub4.createRSString("hint_mapedge", (byte)-120);
   ...
   static RSString aClass94_2168 = Class3_Sub4.createRSString("<br>", (byte)-122);
   ...
   static final RSInterface getRSInterface(byte var0, int interfaceHash) {
      try {
         ...
         if(Class140.aClass11ArrayArray1834[windowId] == null || Class140.aClass11ArrayArray1834[windowId].length <= componentId || null == Class140.aClass11ArrayArray1834[windowId][componentId]) {
            boolean var4 = Canvas_Sub2.method57(windowId, 104);
            if(!var4) {
               return null;
            }
         }
         if (Class140.aClass11ArrayArray1834[windowId].length <= componentId) {
        	 return null;
         }
