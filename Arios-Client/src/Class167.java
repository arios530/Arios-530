...
final class Class167 {
    ...
    static RSString aClass94_2082 = Class3_Sub4.createRSString(" <col=ffff00>", (byte) -127);
    static RSString aClass94_2083 = null;
    static RSString aClass94_2084 = Class3_Sub4.createRSString("ul", (byte) -125);
    static int anInt2085;
    static RSString aClass94_2086 = Class3_Sub4.createRSString("Continuer", (byte) -120);
            ...
            while (true) {
                if (GraphicDefinition.incomingBuffer.method815(Class130.incomingPacketLength, 32666) >= 27) {
                    ...
                    if (32767 != var1) {
                        ...
                        var3.method1987(-1, Node.method522(GraphicDefinition.incomingBuffer.getBits((byte) -11, 14), 27112));
                        if (15 < var7) {
                            var7 -= 32;
                        }
                        ...
                        var3.method1967(-2, var3.getSize((byte) 114), Class102.aClass140_Sub4_Sub1_2141.anIntArray2767[0] + var8, var7 + Class102.aClass140_Sub4_Sub1_2141.anIntArray2755[0], ~var4 == -2);
        ...
        try {
            ...
            if (-1 >= ~var5 && ~var5 > -105 && var4 >= 0 && -105 < ~var4) {
                ...
                while (true) {
                    ...
                    if (49 >= var9) {
                        Class139.aByteArrayArrayArray1828[var8][var5][var4] = var3.getByte(false);
