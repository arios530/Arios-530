package org.kratos.jagex;

final class Class167 {

    static RSString aRSString_2082 = RSString.createRSString(" <col=ffff00>");
    static RSString aRSString_2083 = null;
    static RSString aRSString_2084 = RSString.createRSString("ul");
    static int anInt2085;
    static RSString aRSString_2086 = RSString.createRSString("Continuer");
        ...
        while (true) {
            if (GraphicDefinition.incomingBuffer.method815(Class130.incomingPacketLength, 32666) >= 27) {
                ...
                if (32767 != var1) {
                    ...
                    int var7 = GraphicDefinition.incomingBuffer.getBits((byte) -11, 6); //offsetY
                    int var7_ui = GraphicDefinition.incomingBuffer.getBits((byte) -11, 14); //npcid
                    var3.setDefinitions(-1, Node.method522(var7_ui));
                    if (20 < var7) {
                        var7 -= 42;
                    }
                    int var8 = GraphicDefinition.incomingBuffer.getBits((byte) -11, 6); //offsetX
                    if (20 < var8) {
                        var8 -= 42;
                    }
                    var3.setSize(var3.definition.size);
                    ...
                    var3.method1967(-2, var3.getSize(), Class102.player.anIntArray2767[0] + var8, var7 + Class102.player.anIntArray2755[0], ~var4 == -2);
    ...
    static final void method2266(int var0, int var1, byte var2) {
        try {
            if (Class9.anInt120 != 0 && var1 != -1) {
                Class70.method1285(Node.aCacheIndex_2573, false, var1, 0, false, Class9.anInt120);
    ...
    //parsemapscape
    static final void method2267(int var0, int var1, boolean var2, RSByteBuffer var3, int y, int x, byte var6, int var7, int var8) {
        try {
            int var9;
            if (-1 >= ~x && ~x > -105 && y >= 0 && -105 < ~y) {
                if (!var2) {
                    Class9.underlays[var8][x][y] = 0;
                }

                while (true) {
                    var9 = var3.getByte((byte) -111); //opcode
                    if (-1 == ~var9) {
                        if (!var2) {
                            if (~var8 != -1) {
                                Class44.anIntArrayArrayArray723[var8][x][y] = -240 + Class44.anIntArrayArrayArray723[var8 - 1][x][y];
                            } else {
                                Class44.anIntArrayArrayArray723[0][x][y] = 8 * -Class32.method993(y + 556238 + var1, 125, var0 + x + 932731);
                            }
                        } else {
                            Class44.anIntArrayArrayArray723[0][x][y] = Class58.anIntArrayArrayArray914[0][x][y];
                        }
                        break;
                    }

                    if (var9 == 1) {
                        int var10 = var3.getByte((byte) -110); //tile height
                        if (!var2) {
                            if (~var10 == -2) {
                                var10 = 0;
                            }
                            ...
                            if (-1 == ~var8) {
                                Class44.anIntArrayArrayArray723[0][x][y] = 8 * -var10;
                            } else {
                                Class44.anIntArrayArrayArray723[var8][x][y] = -(var10 * 8) + Class44.anIntArrayArrayArray723[-1 + var8][x][y];
                            }
                        } else {
                            Class44.anIntArrayArrayArray723[0][x][y] = Class58.anIntArrayArrayArray914[0][x][y] - -(var10 * 8);
                        }
                        break;
                    }

                    if (49 >= var9) {
                        Class139.overlays[var8][x][y] = var3.getByte(); //overlay
                        // Class139.aByteArrayArrayArray1828[var8][x][var4] = 15;
                        Class93.overlayOpcodes[var8][x][y] = (byte) ((-2 + var9) / 4);
                        PacketParser.aByteArrayArrayArray81[var8][x][y] = (byte) CS2ScriptDefinition.bitwiseAND(-2 + var9 + var7, 3);
                    } else if (var9 > 81) {
                        Class3_Sub13_Sub36.defaultOpcodes[var8][x][y] = (byte) (-81 + var9); //DEFAULT OPCODE
                    } else if (!var2) {
                        Class9.underlays[var8][x][y] = (byte) (var9 - 49); //default opcode
                    }
                }
            } else {
                while (true) {
            ...
            throw Class44.method1067(var11, "wj.A(" + var0 + ',' + var1 + ',' + var2 + ',' + (var3 != null ? "{...}" : "null") + ',' + y + ',' + x + ',' + var6 + ',' + var7 + ',' + var8 + ')');
        }
    }

    static final int getAmountOf(byte var0, int containerId, int itemId) {
        try {
            ItemContainer var3 = (ItemContainer) Class3_Sub2.itemContainers.get((long) containerId, 0);
            if (var3 != null) {
                if (itemId != -1) {
                    int var4 = 0;

                    for (int var5 = 0; ~var5 > ~var3.itemAmounts.length; ++var5) {
                        if (~itemId == ~var3.itemIds[var5]) {
                            var4 += var3.itemAmounts[var5];
                        }
                    }

                    if (var0 > -45) {
                        aRSString_2086 = (RSString) null;
                    }
            ...
            throw Class44.method1067(var6, "wj.H(" + var0 + ',' + containerId + ',' + itemId + ')');
        }
    }
    ...
    static final void method2269(byte var0) {
        try {
            ...
            WorldMapDetails.anInt1716 = 0;

            for (var1 = 0; RuntimeException_Sub1.hintIcons.length > var1; ++var1) {
                RuntimeException_Sub1.hintIcons[var1] = null;
            }
            ...
            for (var1 = 0; 4 > var1; ++var1) {
                for (int var2 = 0; -105 < ~var2; ++var2) {
                    for (int var3 = 0; ~var3 > -105; ++var3) {
                        Class3_Sub13_Sub22.groundItems[var1][var2][var3] = null;
                    }
                }
            }
            ...
            if (Settings.resizableSD) {
                //This is buggy and causes a black screen on logout on Kratos client, so we probably don't want to enable this feature.
                if (Settings.resizableSDLogoutHD) {
                   System.out.println("Enabling HD logout on Resizable SD... You should probably turn this off...");
                   Class73.resizableSD = false;
                   GameObject.method1862(true, 2, -8914, Class3_Sub9.anInt2334, GameItem.anInt2934);
                   Class73.resizableSD = true;
                   Class73.toggleResizableSD = true;
                } else {
                   GameObject.method1862(true, 0, -8914, Class3_Sub9.anInt2334, GameItem.anInt2934);
                }
            }
        } catch (RuntimeException var4) {
