...
final class Class124 {
   ...
   static RSString aClass94_1660 = Class3_Sub4.createRSString("Versteckt", (byte)-123);
   ...
   static final Class3_Sub28_Sub3 method1747(RSByteBuffer var0, boolean var1) {
      try {
         Class3_Sub28_Sub3 var2 = new Class3_Sub28_Sub3(var0.getString(), var0.getString(), var0.getShort(1), var0.getShort(1), var0.getInt(-502942936), var0.getByte((byte)-91) == 1, var0.getByte((byte)-112));
