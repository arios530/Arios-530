...
final class Class3_Sub24_Sub4 extends Class3_Sub24 {
   ...
   static RSString aClass94_3496 = Class3_Sub4.createRSString("Spielwelt erstellt)3", (byte)-123);
               ...
               for(int var6 = 0; var6 < var3.anInt177; ++var6) {
                  ...
                  if(~var2 <= ~var7 && ~var8 >= ~var0 && 32 + var7 > var2 && ~(var8 + 32) < ~var0) {
                     ...
                     if(-1 > ~var3.anIntArray254[var15]) {
                        ...
                        ItemDefinition var10 = Class38.getItemDefinition(var3.anIntArray254[var15] + -1, (byte)69);
                        if(1 == Class164_Sub1.anInt3012 && var9.method99(31595)) {
                           ...
                           for (RSString v1 : var11) {
                              if (v1 == null)
                                 continue;
                              if (v1.toString().equalsIgnoreCase("drop") || v1.toString().equalsIgnoreCase("release"))
                                 hasDrop = true;
                           }

                           int var12;
                           byte var13;
                           if (var9.method99(31595)) { //drop or release
                              for (var12 = 4; ~var12 <= -4; --var12) {
                                 if (null != var11 && null != var11[var12]) {
                                    ...
                                    if (/*var3.archive != 149 ||*/ !ObjectDefinition.aBooleanArray1490[81] || hasDrop)
                           ...
                           if (/*var3.archive != 149 ||*/ !ObjectDefinition.aBooleanArray1490[81]) { //if shift is not pressed
                              if (var9.method96(-2063688673)) { //use
                                 ++Class25.anInt494;
