...
public abstract class Applet_Sub1 extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   private static RSString aClass94_5 = Class3_Sub4.createRSString(" from your ignore list first)3", (byte)-128);
   static boolean aBoolean6 = false;
   static RSString aClass94_7 = Class3_Sub4.createRSString(" s(West d-Bconnect-B)3", (byte)-123);
   static RSString aClass94_8 = Class3_Sub4.createRSString("", (byte)-118);
   static RSString aClass94_9 = Class3_Sub4.createRSString(")3)3)3", (byte)-128);
   static RSString aClass94_10 = Class3_Sub4.createRSString("::rect_debug", (byte)-128);
   ...
   public final synchronized void paint(Graphics var1) {
      try {
         if(this == Class3_Sub29.anApplet_Sub1_2588 && !Class29.aBoolean554) {
            Class3_Sub13_Sub10.aBoolean3116 = true;
            if(Class137.aBoolean1784 && !Class138.highDetail && ~(-Class142.aLong1847 + Class5.method830((byte)-55)) < -1001L) {
   ...
   public final void run() {
      try {
         try {
            ...
            if(null != Class87.javaVendor) {
               String var1 = Class87.javaVendor.toLowerCase();
               if(var1.indexOf("sun") == -1 && -1 == var1.indexOf("apple")) {
                  if(0 != ~var1.indexOf("ibm") && (Class87.javaVersion == null || Class87.javaVersion.equals("1.4.2"))) {
                     this.method31("wrongjava", -48);
                     return;
                  }
               } else {
                  String var2 = Class87.javaVersion;
            ...
            int var7;
            if(null != Class87.javaVersion && Class87.javaVersion.startsWith("1.")) {
               var7 = 2;

               int var9;
               for(var9 = 0; ~var7 > ~Class87.javaVersion.length(); ++var7) {
                  char var3 = Class87.javaVersion.charAt(var7);
                  if(~var3 > -49 || 57 < var3) {
                     break;
                  }
   ...
   final void method40(int var1, int var2, boolean var3, int var4, String var5, int var6, int var7, int var8) {
      try {
         ...
         try {
            ...
            Class3_Sub13_Sub7.aFrame3092.setTitle("RS");
