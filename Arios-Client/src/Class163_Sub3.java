...
final class Class163_Sub3 extends Class163 {
   ...
   static RSString aClass94_3000 = Class3_Sub4.createRSString("; Max)2Age=", (byte)-119);
   static int anInt3001;
   static RSString aClass94_3002 = Class3_Sub4.createRSString("M", (byte)-121);
   static RSString[] aClass94Array3003 = new RSString[100];
   static boolean aBoolean3004 = true;
   static byte[][] aByteArrayArray3005;
   static RSString aClass94_3006 = Class3_Sub4.createRSString("<col=ff3000>", (byte)-125);
            ...
            if((100 > Class8.anInt104 || Class3_Sub13_Sub29.disableGEBoxes) && ~Class8.anInt104 > -201) {
               ...
               for(var4 = 0; Class8.anInt104 > var4; ++var4) {
                  if(~Class50.aLongArray826[var4] == ~var0) {
                     Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, RenderAnimationDefinition.method903(new RSString[]{var3, Class3_Sub28_Sub11.aClass94_3645}, (byte)-93), -1);
                     return;
                  }
               }
               ...
               for(var4 = 0; ~Class3_Sub28_Sub5.anInt3591 < ~var4; ++var4) {
                  if(~var0 == ~Class114.aLongArray1574[var4]) {
                     Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, RenderAnimationDefinition.method903(new RSString[]{Class38.aClass94_662, var3, Applet_Sub1.aClass94_4}, (byte)-66), -1);
                     return;
                  }
               }

               if(var3.method1528((byte)-42, Class102.aClass140_Sub4_Sub1_2141.displayName)) {
