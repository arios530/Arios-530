         ...
         if(0 != Class3_Sub13_Sub25.loginStage && 5 != Class3_Sub13_Sub25.loginStage) {
            try {
               ...
               if(Class3_Sub13_Sub25.loginStage == 3) {
                  ...
                  Class151_Sub1.aClass3_Sub30_Sub1_2942.putByte((byte)-88, Class83.getScreenMode(0));
                  ...
                  Class151_Sub1.aClass3_Sub30_Sub1_2942.putInt(var0 ^ 127, Class140_Sub6.aClass153_2906.getCRCValue((byte)-125));
                  ...
                  Class151_Sub1.aClass3_Sub30_Sub1_2942.putInt(-126, Class3_Sub1.aClass153_2203.getCRCValue((byte)-122));
               ...
               if(-5 == ~Class3_Sub13_Sub25.loginStage) {
                  ...
                  if(~opcode != -22) {
                     if(opcode != 29) {
                        ...
                        System.out.println("LoginStage 8");
                        Class3_Sub13_Sub25.loginStage = 8;
                     } else {
                        System.out.println("LoginStage 10");
                        Class3_Sub13_Sub25.loginStage = 10;
                     }
                  } else {

                     System.out.println("LoginStage 7");
