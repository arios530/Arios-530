...
final class Class140_Sub6 extends Class140 {
   ...
   static CacheIndex aClass153_2906;
   int anInt2907;
   ...
   static final Class3_Sub28_Sub16[] method2027(int var0, byte var1, int var2, CacheIndex var3) {
      try {
   ...
   Class140_Sub6(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      try {
         ...
         if(0 != ~var12) {
            this.aClass142_2923 = client.method45(var12, (byte)-20);
         } else {
