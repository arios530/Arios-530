...
final class Class3_Sub13_Sub14 extends Class3_Sub13 {
   ...
   static RSString aClass94_3161 = Class3_Sub4.createRSString("_", (byte)-128);
   ...
   static RSString aClass94_3168 = Class3_Sub4.createRSString("cross", (byte)-123);
   static RSString aClass94_3169 = Class3_Sub4.createRSString("Lade Sprites )2 ", (byte)-119);
   private static RSString aClass94_3170 = Class3_Sub4.createRSString("Loaded textures", (byte)-128);
   static int[] anIntArray3171 = new int[]{0, 4, 4, 8, 0, 0, 8, 0, 0};
   static RSString aClass94_3172 = Class3_Sub4.createRSString("Regarder dans cette direction", (byte)-119);
      ...
      try {
         ...
         for(var1 = 0; ~var1 > ~Class139.anInt1829; ++var1) {
            ...
            if(~Class3_Sub13_Sub24.npcs[var2].anInt2838 != ~Class44.anInt719) {
               ...
               Class3_Sub13_Sub24.npcs[var2].method1987(-1, (NPCDefinition)null);
