...
final class Class3_Sub13_Sub3 extends Class3_Sub13 {
   ...
   private static RSString aClass94_3048 = Class3_Sub4.createRSString("Hidden", (byte)-119);
   ...
   static RSString aClass94_3053 = Class3_Sub4.createRSString("Lade Schrifts-=tze )2 ", (byte)-125);
   ...
   static final boolean method181(int var0) {
      try {
         ...
         try {
            ...
            String var2 = "T2 - " + RSString.incomingOpcode + "," + Class7.anInt2166 + "," + Class24.anInt469 + " - " + Class130.incomingPacketLength + "," + (Class131.anInt1716 - -Class102.aClass140_Sub4_Sub1_2141.anIntArray2767[0]) + "," + (Class102.aClass140_Sub4_Sub1_2141.anIntArray2755[0] + Class82.anInt1152) + " - ";
