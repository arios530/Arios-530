...
final class Class3_Sub20 extends Class3 {
   ...
   static RSString aClass94_2482 = Class3_Sub4.createRSString(":clan:", (byte)-119);
   int anInt2483;
   static int wlPacketIndex = 0;
   static int language = 0;
   private static RSString aClass94_2486 = Class3_Sub4.createRSString("red:", (byte)-122);
   ...
   static final void method388(byte var0) {
      try {
         ...
         if(Class3_Sub13_Sub19.aClass94_3220 != null) {
            ...
            //Maybe we shouldn't have this as main, since it may break something?
            //We probably don't need to hardcode main here for world map.
            //System.out.println("Maybe this shouldn't be main");
