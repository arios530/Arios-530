...
final class Class3_Sub9 extends Class3 {
   ...
   int anInt2321;
   int anInt2322 = 0;
   static RSString aClass94_2323 = Class3_Sub4.createRSString("<img=0>", (byte)-127);
   ...
   static RSString aClass94_2331 = Class3_Sub4.createRSString("", (byte)-125);
   int anInt2332;
   int[] anIntArray2333;
   static int anInt2334;
   static RSString aClass94_2335 = Class3_Sub4.createRSString("(Y", (byte)-119);
