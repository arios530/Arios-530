...
final class Class3_Sub13_Sub36 extends Class3_Sub13 {
   ...
   private static RSString aClass94_3428 = Class3_Sub4.createRSString(" more options", (byte)-126);
   static CacheIndex aClass153_3429;
   static byte[][][] aByteArrayArrayArray3430;
   private int anInt3431;
   static RSString aClass94_3432 = Class3_Sub4.createRSString("Schrifts-=tze geladen)3", (byte)-121);
   private int anInt3433;
   private int anInt3434 = -1;
   static float aFloat3435;
   static RSString aClass94_3436 = Class3_Sub4.createRSString("jaune:", (byte)-126);
   private static RSString aClass94_3437 = Class3_Sub4.createRSString("Attack", (byte)-126);
   ...
   static final void method338(int var0, int var1, boolean var2, int var3, int var4, int var5) {
      try {
         ...
         if(1 == Class133.anInt1753) {
            var7 = 2047 & Class3_Sub29.anInt2589 + GraphicDefinition.anInt531;
            ...
            Class140_Sub2.method1952(Class3_Sub13_Sub13.anInt3155, -1907397104, var1, Class121.method1736(WorldListCountry.localPlane, 1, Class102.aClass140_Sub4_Sub1_2141.anInt2819, Class102.aClass140_Sub4_Sub1_2141.anInt2829) + -50, client.anInt1855 - -(var6 * 3), var7, Class62.anInt942, var6);
         }
         ...
         if(var0 == -6403) {
            ...
            if(Class138.highDetail) {
               Class138.method1846(); //something with lighting
               Class138.method1831(true);
               boolean var18 = false;
               Class138.method1827(true); //front of fog
               ...
               Class138.method1849(var12); //render fog color
               ...
               // System.out.println(NPC.anInt3995 + " " + Class7.anInt2162 + " " +  Class77.anInt1111 + " " + Class139.anInt1823 + " " + Class3_Sub13_Sub25.anInt3315 + " " + var19 + " ");
              //rest of fog
              // Class3_Sub13_Sub25.anInt3315 = 10;
              // Class139.anInt1823 = 35;
               
               //this is for maps var0/128,  var2/128
               Class3_Sub22.method398(NPC.anInt3995, Class7.anInt2162, Class77.anInt1111, Class139.anInt1823, Class3_Sub13_Sub25.anInt3315, Class158.aByteArrayArrayArray2008, Class41.anIntArray686, Class129_Sub1.anIntArray2696, Class159.anIntArray2021, Player.anIntArray3959, Class142.anIntArray1871, WorldListCountry.localPlane + 1, var19, Class102.aClass140_Sub4_Sub1_2141.anInt2819 >> 7, Class102.aClass140_Sub4_Sub1_2141.anInt2829 >> 7);
   ...
   static final Class109[] method343(int var0) {
      try {
         ...
         for(int var2 = 0; ~Class95.anInt1338 < ~var2; ++var2) {
            if(!Class138.highDetail) {
               var1[var2] = new Class109_Sub1(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[var2], RSByteBuffer.anIntArray2591[var2], Class140_Sub7.anIntArray2931[var2], Class3_Sub13_Sub6.anIntArray3076[var2], Class163_Sub1.aByteArrayArray2987[var2], Class3_Sub13_Sub38.anIntArray3446);
            } else {
               var1[var2] = new Class109_Sub2(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[var2], RSByteBuffer.anIntArray2591[var2], Class140_Sub7.anIntArray2931[var2], Class3_Sub13_Sub6.anIntArray3076[var2], Class163_Sub1.aByteArrayArray2987[var2], Class3_Sub13_Sub38.anIntArray3446);
            }
         }
