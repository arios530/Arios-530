...
final class Class3_Sub28_Sub12 extends Node {

   static RSString aClass94_3646 = Class3_Sub4.createRSString("D-Bmarrage de la librairie 3D", (byte)-124);
   int anInt3647 = 0;
   static Canvas aCanvas3648;
   static RSString aClass94_3649 = Class3_Sub4.createRSString("Fichiers config charg-Bs", (byte)-124);
   static RSString aClass94_3650 = Class3_Sub4.createRSString("Fermer", (byte)-125);
   static RSString aClass94_3651 = Class3_Sub4.createRSString("::mm", (byte)-123);
   static int anInt3652;
   static RSString aClass94_3653 = Class3_Sub4.createRSString("Shift)2click disabled)3", (byte)-128);
   ...
   static RSString aClass94_3656 = Class3_Sub4.createRSString("Impossible de trouver ", (byte)-121);
