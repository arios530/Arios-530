...
final class Class2 {
	...
	private static RSString aClass94_68 = Class3_Sub4.createRSString("glow1:", (byte)-118);
	...
	final Class109_Sub1 method77(int var1, byte var2) {
		try {
			Class109_Sub1 var3 = (Class109_Sub1)Class3_Sub13_Sub31.aClass93_3369.get((long)(var1 << 16 | this.anInt64), (byte)121);
			if(var3 != null) {
				return var3;
			} else {
			...
			if(324 != var2) {
				if(-326 != ~var2) {
					if(var2 == 327) {
						...
						if(null == Class102.aClass140_Sub4_Sub1_2141.displayName) {
							var1.anInt201 = 0;
						} else {
							var1.anInt182 = 150;
							var1.anInt308 = 2047 & (int)(256.0D * Math.sin((double)Class44.anInt719 / 40.0D));
							var1.anInt202 = 5;
							var1.anInt201 = 2047 + ((int)Class102.aClass140_Sub4_Sub1_2141.displayName.toLong(var0 + 18) << 11);
